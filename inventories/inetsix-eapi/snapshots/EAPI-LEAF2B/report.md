...
-------------- ------------ ----------- ----------- ---------- ---------------- 
192.168.255.1   3716090408   209282084          NA   multihop   08/25/21 18:45  
192.168.255.2   2537728760   540297934          NA   multihop   08/25/21 18:30  
...
Neighbor Status Codes: m - Under maintenance
  ...
  EAPI-SPINE1              192.168.255.1    4  65001            763       721    0    0 00:12:37 Estab   50     50
  EAPI-SPINE2              192.168.255.2    4  65001            365       326    0    0 00:27:26 Estab   50     50
```
## show bgp evpn
 ...
 *  ec   RD: 192.168.254.8:1 ethernet-segment 0000:0000:0303:0202:0101 192.168.254.8
                                192.168.254.8         -       100     0       65001 65104 i
 * >     RD: 192.168.255.6:11 ip-prefix 1.1.1.0/24
                                -                     -       100     0       65001 65105 ?
 ...
 *  ec   RD: 192.168.255.10:11 ip-prefix 10.1.10.0/24
                                192.168.254.9         -       100     0       65001 65105 i
 * >     RD: 192.168.255.6:11 ip-prefix 10.1.10.1/32
                                -                     -       100     0       65001 65101 ?
 ...
 *  ec   RD: 192.168.255.4:11 ip-prefix 10.255.251.0/31
                                192.168.254.3         -       100     0       65001 65101 i
 * >     RD: 192.168.255.6:11 ip-prefix 10.255.251.0/31
                                -                     -       100     0       65001 65101 ?
 * >     RD: 192.168.255.6:11 ip-prefix 10.255.251.4/31
                                -                     -       -       0       i
 *       RD: 192.168.255.6:11 ip-prefix 10.255.251.4/31
                                -                     -       100     0       ?
 * >     RD: 192.168.255.6:11 ip-prefix 10.255.251.12/31
                                -                     -       100     0       65001 65105 ?
...
Neighbor Status Codes: m - Under maintenance
  Description              Neighbor         V  AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  EAPI-LEAF2A              10.255.251.4     4  65102            144       144    0    0 01:52:02 Estab   14     14
  EAPI-SPINE1_Ethernet4    172.31.255.12    4  65001            143       142    0    0 01:52:05 Estab   11     11
  EAPI-SPINE2_Ethernet4    172.31.255.14    4  65001            146       145    0    0 01:52:04 Estab   11     11

BGP summary information for VRF TENANT_A_PROJECT01
Router identifier 192.168.255.6, local AS number 65102
Neighbor Status Codes: m - Under maintenance
  Neighbor         V  AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  10.255.251.4     4  65102            185       185    0    0 00:21:06 Estab   8      8
```
...
Vlan3010       10.255.251.5/31     up            up              1500           
...
Gateway of last resort is not set
 ...
 C        10.255.251.4/31 is directly connected, Vlan4093
 C        10.255.252.4/31 is directly connected, Vlan4094
 ...
 B E      192.168.254.9/32 [20/0] via 172.31.255.12, Ethernet1
                                  via 172.31.255.14, Ethernet2
 B E      192.168.255.1/32 [20/0] via 172.31.255.12, Ethernet1
 B E      192.168.255.2/32 [20/0] via 172.31.255.14, Ethernet2
 B E      192.168.255.3/32 [20/0] via 172.31.255.12, Ethernet1
                                  via 172.31.255.14, Ethernet2
 B E      192.168.255.4/32 [20/0] via 172.31.255.12, Ethernet1
                                  via 172.31.255.14, Ethernet2
 B I      192.168.255.5/32 [200/0] via 10.255.251.4, Vlan4093
...
----    -----------       ----        -----      -----   ---------
 ...
 110    5001.0056.2a6e    DYNAMIC     Vx1        1       0:01:07 ago
 111    0c1d.c0a3.43e0    STATIC      Po3
 112    5001.0002.f6c5    DYNAMIC     Po5        1       0:21:40 ago
 112    5001.0056.2a6e    DYNAMIC     Vx1        1       0:21:41 ago
1199    0c1d.c0a3.43e0    STATIC      Po3
...
Peer State                      :             primary
State changes                   :                   2
Last state change time          :         1:53:03 ago
Hardware ready                  :                True
Failover                        :               False
...
Heartbeats sent/received        :           1707/1696
Peer monotonic clock offset     :   -4.698134 seconds
...
----  -----------     ----     ---  ----             -----   ---------
 110  5001.0056.2a6e  EVPN     Vx1  192.168.254.3    1       0:00:54 ago
 112  5001.0056.2a6e  EVPN     Vx1  192.168.254.3    1       0:21:28 ago
