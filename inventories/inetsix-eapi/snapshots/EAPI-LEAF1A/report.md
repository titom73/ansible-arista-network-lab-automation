...
-------------- ----------- ------------ ----------- ---------- ---------------- 
192.168.255.1  1805861970   2433161046          NA   multihop   08/25/21 18:45  
192.168.255.2  4007573049    969626910          NA   multihop   08/25/21 18:30  
...
Neighbor Status Codes: m - Under maintenance
  ...
  EAPI-SPINE1              192.168.255.1    4  65001            772       747    0    0 00:12:37 Estab   46     46
  EAPI-SPINE2              192.168.255.2    4  65001            330       342    0    0 00:27:40 Estab   46     46
```
## show bgp evpn
 ...
 *  ec   RD: 192.168.254.8:1 ethernet-segment 0000:0000:0303:0202:0101 192.168.254.8
                                192.168.254.8         -       100     0       65001 65104 i
 * >     RD: 192.168.255.3:11 ip-prefix 1.1.1.0/24
                                -                     -       100     0       65001 65105 ?
 ...
 *       RD: 192.168.255.3:11 ip-prefix 10.255.251.0/31
                                -                     -       100     0       ?
 * >     RD: 192.168.255.3:11 ip-prefix 10.255.251.4/31
                                -                     -       100     0       65001 65102 ?
 ...
 *  ec   RD: 192.168.255.6:11 ip-prefix 10.255.251.4/31
                                192.168.254.5         -       100     0       65001 65102 i
 * >     RD: 192.168.255.3:11 ip-prefix 10.255.251.12/31
                                -                     -       100     0       65001 65105 ?
...
Vl112                          admin down     down               PR01-TRUST
Vl1199                         up             up                 
...
Neighbor Status Codes: m - Under maintenance
  Description              Neighbor         V  AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  EAPI-LEAF1B              10.255.251.1     4  65101            139       143    0    0 01:52:00 Estab   14     14
  EAPI-SPINE1_Ethernet1    172.31.255.0     4  65001            146       150    0    0 01:52:00 Estab   11     11
  EAPI-SPINE2_Ethernet1    172.31.255.2     4  65001            141       151    0    0 01:52:00 Estab   11     11

BGP summary information for VRF TENANT_A_PROJECT01
Router identifier 192.168.255.3, local AS number 65101
Neighbor Status Codes: m - Under maintenance
  Neighbor         V  AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  10.255.251.1     4  65101            174       175    0    0 00:21:14 Estab   7      7
```
...
Vlan112        10.1.12.254/24      admin down    down            1500           
Vlan1199       unassigned          up            up              9164           
Vlan3010       10.255.251.0/31     up            up              1500           
...
Gateway of last resort is not set
 ...
 C        10.255.251.0/31 is directly connected, Vlan4093
 ...
 B E      192.168.254.9/32 [20/0] via 172.31.255.0, Ethernet1
                                  via 172.31.255.2, Ethernet2
 B E      192.168.255.1/32 [20/0] via 172.31.255.0, Ethernet1
 B E      192.168.255.2/32 [20/0] via 172.31.255.2, Ethernet2
 C        192.168.255.3/32 is directly connected, Loopback0
 B I      192.168.255.4/32 [200/0] via 10.255.251.1, Vlan4093
...
Gateway of last resort is not set
 ...
 C        10.255.251.0/31 is directly connected, Vlan3010
...
----    -----------       ----        -----      -----   ---------
 ...
 110    5001.0056.2a6e    DYNAMIC     Po5        1       0:01:08 ago
 111    0c1d.c0f4.7b39    STATIC      Po3
 112    5001.0002.f6c5    DYNAMIC     Vx1        1       0:21:39 ago
 112    5001.0056.2a6e    DYNAMIC     Po5        1       0:21:41 ago
1199    0c1d.c0e4.777b    DYNAMIC     Vx1        1       0:11:17 ago
1199    0c1d.c0f4.7b39    STATIC      Po3
...
State changes                   :                   2
Last state change time          :         1:52:49 ago
Hardware ready                  :                True
Failover                        :               False
...
Heartbeats sent/received        :           1708/1695
Peer monotonic clock offset     :    2.207355 seconds
...
112   PR01-TRUST                       active    Po3, Po5, Vx1
...
----  -----------     ----     ---  ----             -----   ---------
 112  5001.0002.f6c5  EVPN     Vx1  192.168.254.5    1       0:21:27 ago
1199  0c1d.c0e4.777b  EVPN     Vx1  192.168.254.7    1       0:11:05 ago
