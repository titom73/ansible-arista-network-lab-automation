...
| --------- | --------------- | ------------ | --------- |
| EAPI_L2LEAF1 | Vlan4094 | 172.31.253.0 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_EAPI-L2LEAF01A_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_EAPI-L2LEAF01A_Ethernet4 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
!
interface Ethernet3
   description MLAG_PEER_EAPI-L2LEAF01A_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_EAPI-L2LEAF01A_Ethernet4
   no shutdown
   channel-group 3 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_EAPI-L2LEAF01A_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_EAPI-L2LEAF01A_Po3
   no shutdown
   switchport
...
| 172.31.253.2 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | CENTRAL_ROUTING |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| CENTRAL_ROUTING | 192.168.253.3:13 | 13:13 | - | - | learned | 301-302 |
...
router bgp 65107
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER remote-as 65107
   ...
   neighbor 172.31.253.2 description EAPI-L2LEAF01A
