...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 |  P2P_LINK_TO_EAPI-SPINE1_Ethernet4  |  routed  | - |  172.31.255.13/31  |  default  |  1500  |  -  |  -  |  -  |
| Ethernet2 |  P2P_LINK_TO_EAPI-SPINE2_Ethernet4  |  routed  | - |  172.31.255.15/31  |  default  |  1500  |  -  |  -  |  -  |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_EAPI-LEAF2A_Po3 | switched | access | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
| Port-Channel5 | EAPI_L2LEAF2_Po1 | switched | access | 110-112,201 | - | - | - | - | 5 | - |
...
| ---------- | --------- | ------------------------- | -------------------- | --- | ------- | ----------------------------- | ---------------------------- |
| 100 | 192.168.255.6 |  enabled   |   Ethernet1 <br> Ethernet2 <br> Vlan4093 <br>|  disabled  | 12000 |  disabled  |  disabled |
