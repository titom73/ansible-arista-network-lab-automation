...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 192.168.0.15/24 | 192.168.200.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_POD1_LEAF2 | Vlan4094 | 10.255.252.4 | Port-Channel1 |
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | MLAG_PEER_DC1-POD1-LEAF2A_Ethernet1 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 1 | active |
| Ethernet2 | P2P_LINK_TO_DC1-POD1-SPINE1_Ethernet5 | 1500 | routed | access | - | - | - | 172.31.255.13/31 | - | - |
| Ethernet3 | P2P_LINK_TO_DC1-POD1-SPINE2_Ethernet5 | 1500 | routed | access | - | - | - | 172.31.255.15/31 | - | - |
| Ethernet6 | MLAG_PEER_DC1-POD1-LEAF2A_Ethernet6 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 1 | active |
| Ethernet7 | DC1-POD1-L2LEAF2A_Ethernet2 | *1500 | *switched | *trunk | * | - | - | - | 7 | active |
...
!
interface Ethernet1
   description MLAG_PEER_DC1-POD1-LEAF2A_Ethernet1
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --------------------- ! ------------------ | ------- | -------- | --- | ---------- | ------------ |
| Port-Channel1 | MLAG_PEER_DC1-POD1-LEAF2A_Po1 | 1500 | switched | trunk | 2-4094 | LEAF_PEER_L3<br> MLAG | - | - | - | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_DC1-POD1-LEAF2A_Po1
...
| Vlan3030 | MLAG_PEER_L3_iBGP: vrf Tenant_C_WAN_Zone | Tenant_C_WAN_Zone | 10.255.254.5/31 | - | - |
| Vlan4025 | MLAG_PEER_L3_iBGP: vrf Common_VRF | Common_VRF | 10.255.254.5/31 | - | - |
| Vlan4093 | MLAG_PEER_L3_PEERING | default | 10.255.254.5/31 | - | - |
| Vlan4094 | MLAG_PEER | default | 10.255.252.5/31 | - | - |
...
| Neighbor | Remote AS |
| -------- | ---------
| 10.255.254.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
