...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | P2P_LINK_TO_EAPI-SPINE1_Ethernet6 | 1500 | routed | access | - | - | - | 172.31.255.29/31 | - | - |
| Ethernet2 | P2P_LINK_TO_EAPI-SPINE2_Ethernet6 | 1500 | routed | access | - | - | - | 172.31.255.31/31 | - | - |
| Ethernet3 | MLAG_PEER_EAPI-BL01A_Ethernet3 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
| Ethernet4 | MLAG_PEER_EAPI-BL01A_Ethernet4 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --------------------- ! ------------------ | ------- | -------- | --- | ---------- | ------------ |
| Port-Channel3 | MLAG_PEER_EAPI-BL01A_Po3 | 1500 | switched | trunk | 2-4094 | LEAF_PEER_L3<br> MLAG | - | - | - | - | - | - | - |
