...
| --------- | --------------- | ------------ | --------- |
| EAPI_BL01 | Vlan4094 | 10.255.252.12 | Port-Channel3 |
...
| -------- | --------- | --- |
| 10.255.251.12 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default |
...
router bgp 65105
   ...
   neighbor 10.255.251.12 description EAPI-BL01A
