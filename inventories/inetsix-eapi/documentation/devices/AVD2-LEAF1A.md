...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | P2P_LINK_TO_AVD2-SPINE1_Ethernet1 | 1500 | routed | access | - | - | - | 172.31.255.1/31 | - | - |
...
| Ethernet5 | AVD2-AGG01_Ethernet1 | *1500 | *switched | *trunk | *110,112,201 | - | - | - | 5 | active |
...
| --------- | --------------- | ------------ | --------- |
| AVD2_LEAF1 | Vlan4094 | 10.255.252.1 | Port-Channel3 |
