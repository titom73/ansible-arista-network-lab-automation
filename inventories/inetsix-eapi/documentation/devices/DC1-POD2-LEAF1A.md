...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 192.169.0.12/24 | 192.168.200.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_POD2_LEAF1 | Vlan4094 | 10.254.252.1 | Port-Channel1 |
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | MLAG_PEER_DC1-POD2-LEAF1B_Ethernet1 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 1 | active |
| Ethernet2 | P2P_LINK_TO_DC1-POD2-SPINE1_Ethernet2 | 1500 | routed | access | - | - | - | 172.32.255.1/31 | - | - |
| Ethernet3 | P2P_LINK_TO_DC1-POD2-SPINE2_Ethernet2 | 1500 | routed | access | - | - | - | 172.32.255.3/31 | - | - |
| Ethernet6 | MLAG_PEER_DC1-POD2-LEAF1B_Ethernet6 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 1 | active |
| Ethernet7 | DC1-POD2-L2LEAF1A_Ethernet1 | *1500 | *switched | *trunk | *12,110-112,120-121,130-131 | - | - | - | 7 | active |
| Ethernet20 | P2P_LINK_TO_DC1-POD2-LEAF1A_Ethernet1 | 1500 | routed | access | - | - | - | 172.32.255.4/31 | - | - |
...
!
interface Ethernet1
   description MLAG_PEER_DC1-POD2-LEAF1B_Ethernet1
...
!
interface Ethernet6
   description MLAG_PEER_DC1-POD2-LEAF1B_Ethernet6
   channel-group 1 mode active
!
interface Ethernet7
   description DC1-POD2-L2LEAF1A_Ethernet1
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --------------------- ! ------------------ | ------- | -------- | --- | ---------- | ------------ |
| Port-Channel1 | MLAG_PEER_DC1-POD2-LEAF1B_Po1 | 1500 | switched | trunk | 2-4094 | LEAF_PEER_L3<br> MLAG | - | - | - | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_DC1-POD2-LEAF1B_Po1
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.169.255.3/32 |
...
| Vlan3010 | MLAG_PEER_L3_iBGP: vrf Tenant_A_WEB_Zone | Tenant_A_WEB_Zone | 10.254.254.0/31 | - | - |
| Vlan4093 | MLAG_PEER_L3_PEERING | default | 10.254.254.0/31 | - | - |
| Vlan4094 | MLAG_PEER | default | 10.254.252.0/31 | - | - |
...
| Neighbor | Remote AS |
| -------- | ---------
| 10.254.254.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.32.250.1 | 65100 |
| 172.32.250.2 | 65100 |
| 172.32.255.0 | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.32.255.2 | Inherited from peer group IPv4-UNDERLAY-PEERS |
...
router bgp 65201
   ...
   neighbor 10.254.254.1 peer group MLAG-IPv4-UNDERLAY-PEER
   ...
   neighbor 172.32.255.0 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.32.255.2 peer group IPv4-UNDERLAY-PEERS
