...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 192.169.0.15/24 | 192.168.200.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_POD2_LEAF2 | Vlan4094 | 10.254.252.4 | Port-Channel1 |
...
!
mlag configuration
   domain-id DC1_POD2_LEAF2
   local-interface Vlan4094
   peer-address 10.254.252.4
   peer-address heartbeat 192.169.0.14 vrf MGMT
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | MLAG_PEER_DC1-POD2-LEAF2A_Ethernet1 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 1 | active |
| Ethernet2 | P2P_LINK_TO_DC1-POD2-SPINE1_Ethernet5 | 1500 | routed | access | - | - | - | 172.32.255.13/31 | - | - |
| Ethernet3 | P2P_LINK_TO_DC1-POD2-SPINE2_Ethernet5 | 1500 | routed | access | - | - | - | 172.32.255.15/31 | - | - |
| Ethernet6 | MLAG_PEER_DC1-POD2-LEAF2A_Ethernet6 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 1 | active |
| Ethernet8 | DC1-L2LEAF2A_Ethernet2 | *1500 | *switched | *trunk | * | - | - | - | 8 | active |
...
!
interface Ethernet1
   description MLAG_PEER_DC1-POD2-LEAF2A_Ethernet1
...
!
interface Ethernet6
   description MLAG_PEER_DC1-POD2-LEAF2A_Ethernet6
   channel-group 1 mode active
!
interface Ethernet8
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --------------------- ! ------------------ | ------- | -------- | --- | ---------- | ------------ |
| Port-Channel1 | MLAG_PEER_DC1-POD2-LEAF2A_Po1 | 1500 | switched | trunk | 2-4094 | LEAF_PEER_L3<br> MLAG | - | - | - | - | - | - | - |
| Port-Channel8 | DC1_POD2_L2LEAF2_Po1 | 1500 | switched | trunk |  | - | - | - | 8 | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_DC1-POD2-LEAF2A_Po1
...
interface Port-Channel8
   description DC1_POD2_L2LEAF2_Po1
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.169.255.6/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 192.169.254.5/32 |
...
interface Loopback0
   ...
   ip address 192.169.255.6/32
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   ip address 192.169.254.5/32
```
...
| Vlan3030 | MLAG_PEER_L3_iBGP: vrf Tenant_C_WAN_Zone | Tenant_C_WAN_Zone | 10.254.254.5/31 | - | - |
| Vlan4025 | MLAG_PEER_L3_iBGP: vrf Common_VRF | Common_VRF | 10.254.254.5/31 | - | - |
| Vlan4093 | MLAG_PEER_L3_PEERING | default | 10.254.254.5/31 | - | - |
| Vlan4094 | MLAG_PEER | default | 10.254.252.5/31 | - | - |
...
| Neighbor | Remote AS |
| -------- | ---------
| 10.254.254.4 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.32.250.1 | 65100 |
| 172.32.250.2 | 65100 |
| 172.32.255.12 | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.32.255.14 | Inherited from peer group IPv4-UNDERLAY-PEERS |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 310 | 65202:30310 |  65000:30310 |  -  | -  | learned |
| 311 | 65202:30311 |  65000:30311 |  -  | -  | learned |
| 350 | 65202:30350 |  65000:30350 |  -  | -  | learned |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Common_VRF | 65202:1026 | connected |
| Tenant_C_WAN_Zone | 65202:31 | connected |
...
router bgp 65202
   ...
   neighbor 10.254.254.4 peer group MLAG-IPv4-UNDERLAY-PEER
   ...
   neighbor 172.32.255.12 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.32.255.14 peer group IPv4-UNDERLAY-PEERS
