...
| --------- | --------------- | ------------ | --------- |
| DC1_LEAF2 | Vlan4094 | 172.31.253.5 | Port-Channel7 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | DC1-SPINE1_Ethernet3 | *trunk | *- | *- | *- | 1 |
| Ethernet2 | DC1-SPINE2_Ethernet3 | *trunk | *- | *- | *- | 1 |
| Ethernet7 | MLAG_PEER_DC1-LEAF2B_Ethernet7 | *trunk | *2-4094 | *- | *['MLAG'] | 7 |
| Ethernet8 | MLAG_PEER_DC1-LEAF2B_Ethernet8 | *trunk | *2-4094 | *- | *['MLAG'] | 7 |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | DC1-SPINE1_Po3 | switched | trunk | - | - | - | - | - | 1 | - |
| Port-Channel7 | MLAG_PEER_DC1-LEAF2B_Po7 | switched | trunk | 2-4094 | - | ['MLAG'] | - | - | - | - |
