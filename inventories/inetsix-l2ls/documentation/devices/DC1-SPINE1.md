...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet1 | DC1-LEAF1A_Ethernet1 | *trunk | *- | *- | *- | 1 |
| Ethernet2 | DC1-LEAF1B_Ethernet1 | *trunk | *- | *- | *- | 1 |
| Ethernet3 | DC1-LEAF2A_Ethernet1 | *trunk | *- | *- | *- | 3 |
| Ethernet4 | DC1-LEAF2B_Ethernet1 | *trunk | *- | *- | *- | 3 |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | DC1_LEAF1_Po1 | switched | trunk | - | - | - | - | - | - | - |
| Port-Channel3 | DC1_LEAF2_Po1 | switched | trunk | - | - | - | - | - | - | - |
...
interface Port-Channel1
   description DC1_LEAF1_Po1
   no shutdown
   switchport
   switchport mode trunk
!
interface Port-Channel3
   description DC1_LEAF2_Po1
   no shutdown
   switchport
   switchport mode trunk
```
