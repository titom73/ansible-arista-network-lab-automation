...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.73.255.118/24 | 10.73.255.2 |
...
| TENANT_A_PROJECT01 | 192.168.255.8:11 | 11:11 | - | - | learned | 110-111 |
...
router bgp 65104
   ...
   neighbor 172.31.255.20 description DC1-SPINE1_Ethernet8
   neighbor 172.31.255.22 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.22 remote-as 65001
   neighbor 172.31.255.22 description DC1-SPINE2_Ethernet8
