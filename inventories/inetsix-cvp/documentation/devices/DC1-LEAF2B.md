...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 10.73.255.114/24 | 10.73.255.2 |
...
mlag configuration
   ...
   peer-address heartbeat 10.73.255.113 vrf MGMT
...
| Ethernet5 | DC1-AGG02_Ethernet2 | *trunk | *110,201,311 | *- | *- | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 |  P2P_LINK_TO_DC1-SPINE1_Ethernet4  |  routed  | - |  172.31.255.13/31  |  default  |  1500  |  false  |  -  |  -  |
| Ethernet2 |  P2P_LINK_TO_DC1-SPINE2_Ethernet4  |  routed  | - |  172.31.255.15/31  |  default  |  1500  |  false  |  -  |  -  |
...
!
interface Ethernet5
   description DC1-AGG02_Ethernet2
   no shutdown
...
| Port-Channel5 | DC1_L2LEAF2_Po1 | switched | trunk | 110,201,311 | - | - | - | - | 5 | - |
...
| TENANT_A_PROJECT01 | 192.168.255.6:11 |  11:11  |  |  | learned | 110,311 |
