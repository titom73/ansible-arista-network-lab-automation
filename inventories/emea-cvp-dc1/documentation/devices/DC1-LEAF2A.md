...
| Ethernet5 | DC1-L2LEAF2A_Ethernet1 | *1500 | *switched | *trunk | *110-111,114 | - | - | - | 5 | active |
| Ethernet6 | server02_MLAG_Eth0 | *1500 | *switched | *trunk | *110-114,210,211 | - | - | - | 6 | active |
...
!
interface Ethernet6
   description server02_MLAG_Eth0
