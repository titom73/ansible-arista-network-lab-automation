...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 10.73.1.25/16 | 10.73.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_BL2 | Vlan4094 | 10.255.252.23 | Port-Channel3 |
...
mlag configuration
   ...
   peer-address heartbeat 10.73.1.26 vrf MGMT
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet9 | 1500 | routed | access | - | - | - | 172.31.255.45/31 | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet9 | 1500 | routed | access | - | - | - | 172.31.255.47/31 | - | - |
| Ethernet3 | MLAG_PEER_DC1-BL2B_Ethernet3 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
| Ethernet4 | MLAG_PEER_DC1-BL2B_Ethernet4 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
...
!
interface Ethernet3
   description MLAG_PEER_DC1-BL2B_Ethernet3
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_DC1-BL2B_Ethernet4
   channel-group 3 mode active
```
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --------------------- ! ------------------ | ------- | -------- | --- | ---------- | ------------ |
| Port-Channel3 | MLAG_PEER_DC1-BL2B_Po3 | 1500 | switched | trunk | 2-4094 | LEAF_PEER_L3<br> MLAG | - | - | - | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_DC1-BL2B_Po3
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | Global Routing Table | 192.168.255.14/32 |
...
| Vlan3009 | MLAG_PEER_L3_iBGP: vrf Tenant_A_OP_Zone | Tenant_A_OP_Zone | 10.255.251.22/31 | - | - |
| Vlan4093 | MLAG_PEER_L3_PEERING | Global Routing Table | 10.255.251.22/31 | - | - |
...
| Net-ID | 49.0001.0001.0001.0012.00 |
| Type | level-2 |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A_OP_Zone | 192.168.255.14:10 |  10:10  |  |  | learned | 110-111,114 |
| Tenant_D_OP_Zone_1 | 192.168.255.14:40411 |  40411:40411  |  |  | learned | 411 |
| Tenant_D_OP_Zone_2 | 192.168.255.14:40412 |  40412:40412  |  |  | learned | 412 |
...
router bgp 65000
   ...
   vrf Tenant_A_OP_Zone
      ...
      router-id 192.168.255.14
      neighbor 10.255.251.23 peer group MLAG-IPv4-UNDERLAY-PEER
