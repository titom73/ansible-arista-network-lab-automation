...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.73.1.22/16 | 10.73.0.1 |
...
| Ethernet5 | DC1-L2LEAF3A_Ethernet1 | *trunk | *110-111,114-115,411-412 | *- | *- | 5 |
...
| -------- | --------- | --- |
| 10.255.251.17 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A_OP_Zone | 192.168.255.11:10 | 10:10 | - | - | learned | 110-111,114-115 |
...
router bgp 65111
   ...
   neighbor 10.255.251.17 description DC1-BL1B
   neighbor 172.31.255.32 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.32 description DC1-SPINE1_Ethernet6
   neighbor 172.31.255.34 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.34 description DC1-SPINE2_Ethernet6
