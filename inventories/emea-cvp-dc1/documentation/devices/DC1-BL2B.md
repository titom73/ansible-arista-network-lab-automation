...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 10.73.1.26/16 | 10.73.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_BL2 | Vlan4094 | 10.255.252.22 | Port-Channel3 |
...
mlag configuration
   ...
   peer-address heartbeat 10.73.1.25 vrf MGMT
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet10 | 1500 | routed | access | - | - | - | 172.31.255.49/31 | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet10 | 1500 | routed | access | - | - | - | 172.31.255.51/31 | - | - |
| Ethernet3 | MLAG_PEER_DC1-BL2A_Ethernet3 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
| Ethernet4 | MLAG_PEER_DC1-BL2A_Ethernet4 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
...
!
interface Ethernet3
   description MLAG_PEER_DC1-BL2A_Ethernet3
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_DC1-BL2A_Ethernet4
   channel-group 3 mode active
```
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --------------------- ! ------------------ | ------- | -------- | --- | ---------- | ------------ |
| Port-Channel3 | MLAG_PEER_DC1-BL2A_Po3 | 1500 | switched | trunk | 2-4094 | LEAF_PEER_L3<br> MLAG | - | - | - | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_DC1-BL2A_Po3
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | Global Routing Table | 192.168.255.15/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | Global Routing Table | 192.168.254.14/32 |
...
| Vlan3009 | MLAG_PEER_L3_iBGP: vrf Tenant_A_OP_Zone | Tenant_A_OP_Zone | 10.255.251.23/31 | - | - |
| Vlan4093 | MLAG_PEER_L3_PEERING | Global Routing Table | 10.255.251.23/31 | - | - |
...
| Net-ID | 49.0001.0001.0001.0013.00 |
| Type | level-2 |
...
router isis EVPN_UNDERLAY
   net 49.0001.0001.0001.0013.00
   is-type level-2
   router-id ipv4 192.168.255.15
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A_OP_Zone | 192.168.255.15:10 |  10:10  |  |  | learned | 110-111,114 |
| Tenant_D_OP_Zone_1 | 192.168.255.15:40411 |  40411:40411  |  |  | learned | 411 |
| Tenant_D_OP_Zone_2 | 192.168.255.15:40412 |  40412:40412  |  |  | learned | 412 |
...
router bgp 65000
   ...
   vrf Tenant_A_OP_Zone
      ...
      router-id 192.168.255.15
      neighbor 10.255.251.22 peer group MLAG-IPv4-UNDERLAY-PEER
...
| Sequence | Type | Match and/or Set |
| -------- | ---- | ---------------- |
| 10 | permit | set extcommunity soo 192.168.254.14:1 additive |
...
route-map RM-EVPN-SOO-OUT permit 10
   set extcommunity soo 192.168.254.14:1 additive
```
...
| Sequence | Type | Match and/or Set |
| -------- | ---- | ---------------- |
| ECL-EVPN-SOO | permit | soo 192.168.254.14:1 |

### IP Extended Communities configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 192.168.254.14:1
```
