...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 10.73.1.24/16 | 10.73.0.1 |
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | P2P_LINK_TO_DC1-SPINE1_Ethernet8 | 1500 | routed | access | - | - | - | 172.31.255.41/31 | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE2_Ethernet8 | 1500 | routed | access | - | - | - | 172.31.255.43/31 | - | - |
| Ethernet7 | POD03-ESI_Eth1 | *1500 | *switched | *trunk | *110-114,210,211 | - | - | - | 7 | active |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | Global Routing Table | 192.168.255.13/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | Global Routing Table | 192.168.254.13/32 |
...
| Net-ID | 49.0001.0001.0001.0011.00 |
| Type | level-2 |
...
| Sequence | Type | Match and/or Set |
| -------- | ---- | ---------------- |
| 10 | permit | set extcommunity soo 192.168.254.13:1 additive |
...
```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 192.168.254.13:1
```
