...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 192.168.0.12/24 | 192.168.200.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_POD1_LEAF1 | Vlan4094 | 10.255.252.1 | Port-Channel1 |
...
!
mlag configuration
   domain-id DC1_POD1_LEAF1
   local-interface Vlan4094
   peer-address 10.255.252.1
   peer-address heartbeat 192.168.0.13 vrf MGMT
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | MLAG_PEER_DC1-POD1-LEAF1B_Ethernet1 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 1 | active |
| Ethernet2 | P2P_LINK_TO_DC1-POD1-SPINE1_Ethernet2 | 1500 | routed | access | - | - | - | 172.31.255.1/31 | - | - |
| Ethernet3 | P2P_LINK_TO_DC1-POD1-SPINE2_Ethernet2 | 1500 | routed | access | - | - | - | 172.31.255.3/31 | - | - |
| Ethernet6 | MLAG_PEER_DC1-POD1-LEAF1B_Ethernet6 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 1 | active |
| Ethernet7 | DC1-POD1-L2LEAF1A_Ethernet1 | *1500 | *switched | *trunk | *12,110-112,120-121,130-131 | - | - | - | 7 | active |
| Ethernet20 | P2P_LINK_TO_DC1-POD1-LEAF1A_Ethernet1 | 1500 | routed | access | - | - | - | 172.32.255.0/31 | - | - |
...
!
interface Ethernet1
   description MLAG_PEER_DC1-POD1-LEAF1B_Ethernet1
...
!
interface Ethernet6
   description MLAG_PEER_DC1-POD1-LEAF1B_Ethernet6
   channel-group 1 mode active
!
interface Ethernet7
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --------------------- ! ------------------ | ------- | -------- | --- | ---------- | ------------ |
| Port-Channel1 | MLAG_PEER_DC1-POD1-LEAF1B_Po1 | 1500 | switched | trunk | 2-4094 | LEAF_PEER_L3<br> MLAG | - | - | - | - | - | - | - |
| Port-Channel7 | DC1_POD1_L2LEAF1_Po1 | 1500 | switched | trunk | 12,110-112,120-121,130-131 | - | - | - | 7 | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_DC1-POD1-LEAF1B_Po1
...
interface Port-Channel7
   description DC1_POD1_L2LEAF1_Po1
...
| Loopback100 | Common_VRF_VTEP_DIAGNOSTICS | Common_VRF | 10.255.1.3/32 |
...
| Vlan3010 | MLAG_PEER_L3_iBGP: vrf Tenant_A_WEB_Zone | Tenant_A_WEB_Zone | 10.255.254.0/31 | - | - |
| Vlan4093 | MLAG_PEER_L3_PEERING | default | 10.255.254.0/31 | - | - |
...
| Neighbor | Remote AS |
| -------- | ---------
| 10.255.254.1 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 12 | 65101:10012 |  65000:10012 |  -  | -  | learned |
| 110 | 65101:10110 |  65000:10110 |  -  | -  | learned |
| 111 | 65101:50111 |  65000:50111 |  -  | -  | learned |
| 112 | 65101:50112 |  65000:50112 |  -  | -  | learned |
| 120 | 65101:10120 |  65000:10120 |  -  | -  | learned |
| 121 | 65101:10121 |  65000:10121 |  -  | -  | learned |
| 130 | 65101:10130 |  65000:10130 |  -  | -  | learned |
| 131 | 65101:10131 |  65000:10131 |  -  | -  | learned |
| 140 | 65101:10140 |  65000:10140 |  -  | -  | learned |
| 141 | 65101:10141 |  65000:10141 |  -  | -  | learned |
| 150 | 65101:10150 |  65000:10150 |  -  | -  | learned |
| 160 | 65101:55160 |  65000:55160 |  -  | -  | learned |
| 161 | 65101:10161 |  65000:10161 |  -  | -  | learned |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| Common_VRF | 65101:1025 | connected |
| Tenant_A_APP_Zone | 65101:12 | connected |
| Tenant_A_DB_Zone | 65101:1300 | connected |
| Tenant_A_WAN_Zone | 65101:14 | connected |
| Tenant_A_WEB_Zone | 65101:11 | connected |
...
| -------------- | --------------------- |
| Common_VRF | 10.255.1.3 |

## Virtual Source NAT Configuration

```eos
!
ip address virtual source-nat vrf Common_VRF address 10.255.1.3
```
