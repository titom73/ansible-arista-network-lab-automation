...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 10.73.1.14/16 | 10.73.0.1 |
...
mlag configuration
   ...
   peer-address heartbeat 10.73.1.13 vrf MGMT
...
| Ethernet5 | DC1-L2LEAF1A_Ethernet2 | *1500 | *switched | *trunk | *110-111,114 | - | - | - | 5 | active |
| Ethernet6 | server01_MLAG_Eth1 | *1500 | *switched | *trunk | *110-114,210,211 | - | - | - | 6 | active |
| Ethernet9 | P2P_LINK_TO_DC1_RS01_Ethernet8 | 1500 | routed | access | - | - | - | 172.32.255.2/31 | - | - |
...
!
interface Ethernet6
   description server01_MLAG_Eth1
   channel-group 6 mode active
!
interface Ethernet9
   description P2P_LINK_TO_DC1_RS01_Ethernet8
   no switchport
...
| Vlan3009 | MLAG_PEER_L3_iBGP: vrf Tenant_A_OP_Zone | Tenant_A_OP_Zone | 10.255.251.1/31 | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A_OP_Zone | 192.168.255.4:10 |  10:10  |  |  | learned | 110-111,114 |
