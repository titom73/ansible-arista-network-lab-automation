...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 192.169.0.14/24 | 192.168.200.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_POD2_LEAF2 | Vlan4094 | 10.254.252.5 | Port-Channel1 |
...
mlag configuration
   ...
   peer-address 10.254.252.5
   peer-address heartbeat 192.169.0.15 vrf MGMT
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | MLAG_PEER_DC1-POD2-LEAF2B_Ethernet1 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 1 | active |
| Ethernet2 | P2P_LINK_TO_DC1-POD2-SPINE1_Ethernet4 | 1500 | routed | access | - | - | - | 172.32.255.9/31 | - | - |
| Ethernet3 | P2P_LINK_TO_DC1-POD2-SPINE2_Ethernet4 | 1500 | routed | access | - | - | - | 172.32.255.11/31 | - | - |
| Ethernet6 | MLAG_PEER_DC1-POD2-LEAF2B_Ethernet6 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 1 | active |
| Ethernet8 | DC1-L2LEAF2A_Ethernet1 | *1500 | *switched | *trunk | * | - | - | - | 8 | active |
...
!
interface Ethernet1
   description MLAG_PEER_DC1-POD2-LEAF2B_Ethernet1
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --------------------- ! ------------------ | ------- | -------- | --- | ---------- | ------------ |
| Port-Channel1 | MLAG_PEER_DC1-POD2-LEAF2B_Po1 | 1500 | switched | trunk | 2-4094 | LEAF_PEER_L3<br> MLAG | - | - | - | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_DC1-POD2-LEAF2B_Po1
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.169.255.5/32 |
...
| Vlan3030 | MLAG_PEER_L3_iBGP: vrf Tenant_C_WAN_Zone | Tenant_C_WAN_Zone | 10.254.254.4/31 | - | - |
| Vlan4025 | MLAG_PEER_L3_iBGP: vrf Common_VRF | Common_VRF | 10.254.254.4/31 | - | - |
| Vlan4093 | MLAG_PEER_L3_PEERING | default | 10.254.254.4/31 | - | - |
| Vlan4094 | MLAG_PEER | default | 10.254.252.4/31 | - | - |
...
| Neighbor | Remote AS |
| -------- | ---------
| 10.254.254.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.32.250.1 | 65100 |
| 172.32.250.2 | 65100 |
| 172.32.255.8 | Inherited from peer group IPv4-UNDERLAY-PEERS |
| 172.32.255.10 | Inherited from peer group IPv4-UNDERLAY-PEERS |
...
router bgp 65202
   ...
   neighbor 10.254.254.5 peer group MLAG-IPv4-UNDERLAY-PEER
