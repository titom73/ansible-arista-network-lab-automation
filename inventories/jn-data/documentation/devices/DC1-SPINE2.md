...
| Ethernet5 | P2P_LINK_TO_DC1-LEAF3A_Ethernet2 | 1500 | routed | access | - | - | - | 172.31.255.18/31 | - | - |
| Ethernet6 | P2P_LINK_TO_DC1-BL1A_Ethernet2 | 1500 | routed | access | - | - | - | 172.31.255.26/31 | - | - |
| Ethernet7 | P2P_LINK_TO_DC1-BL1B_Ethernet2 | 1500 | routed | access | - | - | - | 172.31.255.30/31 | - | - |
| Ethernet8 | P2P_LINK_TO_DC1-LEAF4A_Ethernet2 | 1500 | routed | access | - | - | - | 172.31.255.22/31 | - | - |
...
router bgp 65001
   ...
   neighbor 172.31.255.27 remote-as 65110
   neighbor 172.31.255.31 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.31 remote-as 65110
   ...
   neighbor 192.168.255.9 remote-as 65110
   neighbor 192.168.255.10 peer group EVPN-OVERLAY-PEERS
   neighbor 192.168.255.10 remote-as 65110
