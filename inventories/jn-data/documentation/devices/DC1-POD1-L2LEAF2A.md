...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 192.168.0.22/24 | 192.168.200.1 |
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | DC1-POD1-LEAF2A_Ethernet7 | *1500 | *switched | *trunk | * | - | - | - | 1 | active |
| Ethernet2 | DC1-POD1-LEAF2B_Ethernet7 | *1500 | *switched | *trunk | * | - | - | - | 1 | active |
...
!
interface Ethernet1
   description DC1-POD1-LEAF2A_Ethernet7
   channel-group 1 mode active
!
interface Ethernet2
   description DC1-POD1-LEAF2B_Ethernet7
   channel-group 1 mode active
```
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --------------------- ! ------------------ | ------- | -------- | --- | ---------- | ------------ |
| Port-Channel1 | DC1-POD1-LEAF2A_Po7 | 1500 | switched | trunk |  | - | - | - | 1 | - | - | - | - |
...
interface Port-Channel1
   description DC1-POD1-LEAF2A_Po7
