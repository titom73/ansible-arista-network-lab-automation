...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 192.168.0.13/24 | 192.168.200.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_POD1_LEAF1 | Vlan4094 | 10.255.252.0 | Port-Channel1 |
...
mlag configuration
   ...
   peer-address heartbeat 192.168.0.12 vrf MGMT
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | MLAG_PEER_DC1-POD1-LEAF1A_Ethernet1 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 1 | active |
| Ethernet2 | P2P_LINK_TO_DC1-POD1-SPINE1_Ethernet3 | 1500 | routed | access | - | - | - | 172.31.255.5/31 | - | - |
| Ethernet3 | P2P_LINK_TO_DC1-POD1-SPINE2_Ethernet3 | 1500 | routed | access | - | - | - | 172.31.255.7/31 | - | - |
| Ethernet6 | MLAG_PEER_DC1-POD1-LEAF1A_Ethernet6 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 1 | active |
| Ethernet7 | DC1-POD1-L2LEAF1A_Ethernet2 | *1500 | *switched | *trunk | *12,110-112,120-121,130-131 | - | - | - | 7 | active |
| Ethernet20 | P2P_LINK_TO_DC1-POD1-LEAF1B_Ethernet2 | 1500 | routed | access | - | - | - | 172.32.255.2/31 | - | - |
...
!
interface Ethernet1
   description MLAG_PEER_DC1-POD1-LEAF1A_Ethernet1
...
!
interface Ethernet7
   description DC1-POD1-L2LEAF1A_Ethernet2
   channel-group 7 mode active
!
interface Ethernet20
   description P2P_LINK_TO_DC1-POD1-LEAF1B_Ethernet2
   no switchport
   ip address 172.32.255.2/31
```
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --------------------- ! ------------------ | ------- | -------- | --- | ---------- | ------------ |
| Port-Channel1 | MLAG_PEER_DC1-POD1-LEAF1A_Po1 | 1500 | switched | trunk | 2-4094 | LEAF_PEER_L3<br> MLAG | - | - | - | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_DC1-POD1-LEAF1A_Po1
...
| Vlan3010 | MLAG_PEER_L3_iBGP: vrf Tenant_A_WEB_Zone | Tenant_A_WEB_Zone | 10.255.254.1/31 | - | - |
| Vlan4093 | MLAG_PEER_L3_PEERING | default | 10.255.254.1/31 | - | - |
...
| Neighbor | Remote AS |
| -------- | ---------
| 10.255.254.0 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
