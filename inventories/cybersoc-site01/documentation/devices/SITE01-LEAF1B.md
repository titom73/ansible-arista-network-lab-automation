...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 10.255.1.104/24 | 10.255.1.1 |
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | ------- | --- | ---------- |
| Port-Channel3 | MLAG_PEER_SITE01-LEAF1A_Po3 | 1500 | switched | trunk | 2-4094 | LEAF_PEER_L3<br> MLAG | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_SITE01-LEAF1A_Po3
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | P2P_LINK_TO_SITE01-SPINE1_Ethernet2 | 1500 | routed | access | - | - | - | 172.31.255.5/31 | - | - |
| Ethernet2 | P2P_LINK_TO_SITE01-SPINE2_Ethernet2 | 1500 | routed | access | - | - | - | 172.31.255.7/31 | - | - |
| Ethernet3 | MLAG_PEER_SITE01-LEAF1A_Ethernet3 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
| Ethernet4 | MLAG_PEER_SITE01-LEAF1A_Ethernet4 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
| Ethernet5 | POD01-SRV_Eth2 | *1500 | *switched | *access | *110 | - | - | - | 5 | active |
...
```eos
interface Ethernet1
   description P2P_LINK_TO_SITE01-SPINE1_Ethernet2
   no switchport
   ip address 172.31.255.5/31
!
interface Ethernet2
   description P2P_LINK_TO_SITE01-SPINE2_Ethernet2
   no switchport
   ip address 172.31.255.7/31
!
interface Ethernet3
   description MLAG_PEER_SITE01-LEAF1A_Ethernet3
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_SITE01-LEAF1A_Ethernet4
   channel-group 3 mode active
!
interface Ethernet5
   description POD01-SRV_Eth2
...
| --------- | --------------- | ------------ | --------- |
| SITE01_LEAF1 | Vlan4094 | 10.255.252.0 | Port-Channel3 |

### MLAG Device Configuration

```eos
mlag configuration
   domain-id SITE01_LEAF1
   local-interface Vlan4094
   peer-address 10.255.252.0
   peer-address heartbeat 10.255.1.103 vrf MGMT
...
| ----------------- | ------------------- | ------------ | ------------ | ----- |
| B-ELAN-201 | 192.168.255.4:20201 | both 20201:20201 | learned | 201 |
| TENANT_A_PROJECT01 | 192.168.255.4:11 | both 11:11 | learned | 110 |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Route Target | Redistribute |
| --- | ------------------- | ------------ | ------------ |
| TENANT_A_PROJECT01 | 192.168.255.4:11 | import 11:11<br> export 11:11 | connected |
