...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 10.255.1.105/24 | 10.255.1.1 |
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | ------- | --- | ---------- |
| Port-Channel3 | MLAG_PEER_SITE01-LEAF2B_Po3 | 1500 | switched | trunk | 2-4094 | LEAF_PEER_L3<br> MLAG | - | - | - |

### Port-Channel Interfaces Device Configuration

```eos
interface Port-Channel3
   description MLAG_PEER_SITE01-LEAF2B_Po3
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | P2P_LINK_TO_SITE01-SPINE1_Ethernet3 | 1500 | routed | access | - | - | - | 172.31.255.9/31 | - | - |
| Ethernet2 | P2P_LINK_TO_SITE01-SPINE2_Ethernet3 | 1500 | routed | access | - | - | - | 172.31.255.11/31 | - | - |
| Ethernet3 | MLAG_PEER_SITE01-LEAF2B_Ethernet3 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
| Ethernet4 | MLAG_PEER_SITE01-LEAF2B_Ethernet4 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
...
```eos
interface Ethernet1
   description P2P_LINK_TO_SITE01-SPINE1_Ethernet3
   no switchport
   ip address 172.31.255.9/31
!
interface Ethernet2
   description P2P_LINK_TO_SITE01-SPINE2_Ethernet3
   no switchport
   ip address 172.31.255.11/31
!
interface Ethernet3
   description MLAG_PEER_SITE01-LEAF2B_Ethernet3
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_SITE01-LEAF2B_Ethernet4
   channel-group 3 mode active
!
```
...
| --------- | --------------- | ------------ | --------- |
| SITE01_LEAF2 | Vlan4094 | 10.255.252.5 | Port-Channel3 |
...
mlag configuration
   ...
   peer-address heartbeat 10.255.1.106 vrf MGMT
...
| TENANT_A_PROJECT01 | 192.168.255.5:11 | both 11:11 | learned | 110-111 |
