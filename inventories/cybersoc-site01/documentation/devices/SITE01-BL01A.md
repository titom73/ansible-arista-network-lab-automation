...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 10.255.1.107/24 | 10.255.1.1 |
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | ------- | --- | ---------- |
| Port-Channel3 | MLAG_PEER_SITE01-BL01B_Po3 | 1500 | switched | trunk | 2-4094 | LEAF_PEER_L3<br> MLAG | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_SITE01-BL01B_Po3
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | P2P_LINK_TO_SITE01-SPINE1_Ethernet5 | 1500 | routed | access | - | - | - | 172.31.255.25/31 | - | - |
| Ethernet2 | P2P_LINK_TO_SITE01-SPINE2_Ethernet5 | 1500 | routed | access | - | - | - | 172.31.255.27/31 | - | - |
| Ethernet3 | MLAG_PEER_SITE01-BL01B_Ethernet3 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
| Ethernet4 | MLAG_PEER_SITE01-BL01B_Ethernet4 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
| Ethernet5 | DCI_RTR01_Eth1 | *1500 | *switched | *trunk | *201,112 | - | - | - | 5 | active |
...
```eos
interface Ethernet1
   description P2P_LINK_TO_SITE01-SPINE1_Ethernet5
   no switchport
   ip address 172.31.255.25/31
!
interface Ethernet2
   description P2P_LINK_TO_SITE01-SPINE2_Ethernet5
   no switchport
   ip address 172.31.255.27/31
!
interface Ethernet3
   description MLAG_PEER_SITE01-BL01B_Ethernet3
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_SITE01-BL01B_Ethernet4
   channel-group 3 mode active
!
interface Ethernet5
   description DCI_RTR01_Eth1
...
| Vlan3010 | MLAG_PEER_L3_iBGP: vrf TENANT_A_PROJECT01 | TENANT_A_PROJECT01 | 10.255.251.12/31 | - | - |
...
| --------- | --------------- | ------------ | --------- |
| SITE01_BL01 | Vlan4094 | 10.255.252.13 | Port-Channel3 |
...
mlag configuration
   ...
   peer-address heartbeat 10.255.1.108 vrf MGMT
...
| ----------------- | ------------------- | ------------ | ------------ | ----- |
| B-ELAN-201 | 192.168.255.9:20201 | both 20201:20201 | learned | 201 |
| TENANT_A_PROJECT01 | 192.168.255.9:11 | both 11:11 | learned | 112 |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Route Target | Redistribute |
| --- | ------------------- | ------------ | ------------ |
| TENANT_A_PROJECT01 | 192.168.255.9:11 | import 11:11<br> export 11:11 | connected |
