...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 10.255.1.103/24 | 10.255.1.1 |
...
interface Port-Channel3
   description MLAG_PEER_SITE01-LEAF1B_Po3
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | P2P_LINK_TO_SITE01-SPINE1_Ethernet1 | 1500 | routed | access | - | - | - | 172.31.255.1/31 | - | - |
...
```eos
interface Ethernet1
   description P2P_LINK_TO_SITE01-SPINE1_Ethernet1
   no switchport
   ip address 172.31.255.1/31
!
interface Ethernet2
   description P2P_LINK_TO_SITE01-SPINE2_Ethernet1
   no switchport
   ip address 172.31.255.3/31
!
interface Ethernet3
   description MLAG_PEER_SITE01-LEAF1B_Ethernet3
...
| --------- | --------------- | ------------ | --------- |
| SITE01_LEAF1 | Vlan4094 | 10.255.252.1 | Port-Channel3 |
...
mlag configuration
   ...
   peer-address heartbeat 10.255.1.104 vrf MGMT
