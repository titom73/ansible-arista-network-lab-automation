...
------------ ---------- ---------- ------------------- -------- ---------------
192.168.0.26 3113441469 3719478713                  NA multihop 06/21/22 12:34 
192.168.0.27 2312355607 2352463956                  NA multihop 06/21/22 12:34 
...
Router identifier 192.168.255.15, local AS number 65102
Neighbor Status Codes: m - Under maintenance
  Description              Neighbor     V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  avd-rs01                 192.168.0.26 4 65000            312       293    0    0 03:27:32 Estab   72     72
  avd-rs02                 192.168.0.27 4 65000            316       318    0    0 03:27:33 Estab   72     72
```
## show bgp evpn
 ...
 *  ec   RD: 192.168.255.22:11 ip-prefix 10.1.10.0/24
                                 192.168.254.21        -       100     0       65000 65106 i
 * >     RD: 192.168.255.15:11 ip-prefix 10.1.10.3/32
                                 -                     -       100     0       65000 65104 ?
 ...
 *       RD: 192.168.255.15:11 ip-prefix 10.1.12.0/24
                                 -                     -       100     0       ?
 * >     RD: 192.168.255.15:11 ip-prefix 10.1.13.0/24
                                 -                     -       100     0       65000 65104 ?
 ...
 *  ec   RD: 192.168.255.14:13 ip-prefix 10.1.31.0/24
                                 192.168.254.13        -       100     0       65000 65101 i
 * >     RD: 192.168.255.15:13 ip-prefix 10.1.31.0/24
                                 -                     -       100     0       65000 65101 ?
 * >     RD: 192.168.255.15:13 ip-prefix 10.1.32.0/24
                                 -                     -       -       0       i
 *       RD: 192.168.255.15:13 ip-prefix 10.1.32.0/24
                                 -                     -       100     0       ?
 * >     RD: 192.168.255.15:13 ip-prefix 10.3.1.0/24
                                 -                     -       100     0       65000 65106 ?
 ...
 *  ec   RD: 192.168.255.22:13 ip-prefix 10.3.1.0/24
                                 192.168.254.21        -       100     0       65000 65106 i
 * >     RD: 192.168.255.15:13 ip-prefix 10.3.2.0/24
                                 -                     -       100     0       65000 65106 ?
 ...
 *  ec   RD: 192.168.255.14:13 ip-prefix 172.31.253.22/31
                                 192.168.254.13        -       100     0       65000 65101 i
 * >     RD: 192.168.255.15:11 ip-prefix 172.31.253.22/31
                                 -                     -       100     0       65000 65101 ?
 * >     RD: 192.168.255.15:13 ip-prefix 172.31.253.22/31
                                 -                     -       100     0       65000 65101 ?
 ...
 *       RD: 192.168.255.15:13 ip-prefix 172.31.253.26/31
                                 -                     -       100     0       ?
 * >     RD: 192.168.255.15:11 ip-prefix 172.31.253.34/31
                                 -                     -       100     0       65000 65105 ?
 ...
 *  ec   RD: 192.168.255.20:11 ip-prefix 172.31.253.34/31
                                 192.168.254.19        -       100     0       65000 65105 i
 * >     RD: 192.168.255.15:11 ip-prefix 172.31.253.38/31
                                 -                     -       100     0       65000 65106 ?
 * >     RD: 192.168.255.15:13 ip-prefix 172.31.253.38/31
                                 -                     -       100     0       65000 65106 ?
...
Et1                            up             up                 P2P_LINK_TO_AVD-SPINE1_Ethernet3
Et2                            up             up                 P2P_LINK_TO_AVD-SPINE2_Ethernet3
Et5                            up             up                 AVD-AGG02_Ethernet1
Et7                            up             up                 MLAG_PEER_avd-leaf2b_Ethernet7
Et8                            up             up                 MLAG_PEER_avd-leaf2b_Ethernet8
Lo0                            up             up                 EVPN_Overlay_Peering
Lo1                            up             up                 VTEP_VXLAN_Tunnel_Source
Ma0                            up             up                 oob_management
Po5                            up             up                 AVD-AGG02_Po1
Po7                            up             up                 MLAG_PEER_avd-leaf2b_Po7
...
Neighbor Status Codes: m - Under maintenance
  Description              Neighbor      V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  avd-leaf2b               172.31.253.27 4 65102            259       263    0    0 03:27:34 Estab   23     23
  avd-spine1_Ethernet3     172.31.255.48 4 65001            262       260    0    0 03:27:30 Estab   19     19
  avd-spine2_Ethernet3     172.31.255.50 4 65001            258       249    0    0 03:27:31 Estab   19     19

BGP summary information for VRF pure_type5
Router identifier 192.168.255.15, local AS number 65102
Neighbor Status Codes: m - Under maintenance
  Description              Neighbor      V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  avd-leaf2b               172.31.253.27 4 65102            256       258    0    0 03:27:24 Estab   7      7

BGP summary information for VRF tenant_a_project01
Router identifier 192.168.255.15, local AS number 65102
Neighbor Status Codes: m - Under maintenance
  Description              Neighbor      V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  avd-leaf2b               172.31.253.27 4 65102            261       263    0    0 03:27:24 Estab   9      9
```
...
--------------- --------------------- ---------- ------------ --------- -------
Ethernet1       172.31.255.49/31      up         up              1500          
Ethernet2       172.31.255.51/31      up         up              1500          
Loopback0       192.168.255.15/32     up         up             65535          
Loopback1       192.168.254.15/32     up         up             65535          
Management0     10.73.252.13/24       up         up              1500          
...
Vlan3010        172.31.253.26/31      up         up              1500          
Vlan3012        172.31.253.26/31      up         up              1500          
Vlan4093        172.31.253.26/31      up         up              1500          
Vlan4094        172.31.253.24/31      up         up              1500
```
...
Gateway of last resort is not set
 ...
 C        172.31.255.48/31 is directly connected, Ethernet1
 C        172.31.255.50/31 is directly connected, Ethernet2
 B E      192.168.0.26/32 [20/0] via 172.31.255.48, Ethernet1
 B E      192.168.0.27/32 [20/0] via 172.31.255.50, Ethernet2
 B E      192.168.1.1/32 [20/0] via 172.31.255.48, Ethernet1
 B E      192.168.1.2/32 [20/0] via 172.31.255.50, Ethernet2
 B E      192.168.252.22/32 [20/0] via 172.31.255.48, Ethernet1
                                   via 172.31.255.50, Ethernet2
 B E      192.168.252.23/32 [20/0] via 172.31.255.48, Ethernet1
                                   via 172.31.255.50, Ethernet2
 B E      192.168.253.22/32 [20/0] via 172.31.255.48, Ethernet1
                                   via 172.31.255.50, Ethernet2
 B E      192.168.253.23/32 [20/0] via 172.31.255.48, Ethernet1
                                   via 172.31.255.50, Ethernet2
 B E      192.168.254.13/32 [20/0] via 172.31.255.48, Ethernet1
                                   via 172.31.255.50, Ethernet2
 C        192.168.254.15/32 is directly connected, Loopback1
 B E      192.168.254.17/32 [20/0] via 172.31.255.48, Ethernet1
                                   via 172.31.255.50, Ethernet2
 B E      192.168.254.18/32 [20/0] via 172.31.255.48, Ethernet1
                                   via 172.31.255.50, Ethernet2
 B E      192.168.254.19/32 [20/0] via 172.31.255.48, Ethernet1
                                   via 172.31.255.50, Ethernet2
 B E      192.168.254.21/32 [20/0] via 172.31.255.48, Ethernet1
                                   via 172.31.255.50, Ethernet2
 B E      192.168.255.13/32 [20/0] via 172.31.255.48, Ethernet1
                                   via 172.31.255.50, Ethernet2
 B E      192.168.255.14/32 [20/0] via 172.31.255.48, Ethernet1
                                   via 172.31.255.50, Ethernet2
 C        192.168.255.15/32 is directly connected, Loopback0
 B I      192.168.255.16/32 [200/0] via 172.31.253.27, Vlan4093
 B E      192.168.255.17/32 [20/0] via 172.31.255.48, Ethernet1
                                   via 172.31.255.50, Ethernet2
 B E      192.168.255.18/32 [20/0] via 172.31.255.48, Ethernet1
                                   via 172.31.255.50, Ethernet2
 B E      192.168.255.19/32 [20/0] via 172.31.255.48, Ethernet1
                                   via 172.31.255.50, Ethernet2
 B E      192.168.255.20/32 [20/0] via 172.31.255.48, Ethernet1
                                   via 172.31.255.50, Ethernet2
 B E      192.168.255.21/32 [20/0] via 172.31.255.48, Ethernet1
                                   via 172.31.255.50, Ethernet2
 B E      192.168.255.22/32 [20/0] via 172.31.255.48, Ethernet1
                                   via 172.31.255.50, Ethernet2
...
---------- ------------------------ ---------------------- ---
Et1           avd-spine1               Ethernet3           120
Et2           avd-spine2               Ethernet3           120
Et5           avd-agg02                Ethernet1           120
Et7           avd-leaf2b               Ethernet7           120
Et8           avd-leaf2b               Ethernet8           120
...
----    -----------       ----        -----      -----   ---------
 110    001c.736d.9c01    STATIC      Po7
 110    001c.73a4.f92c    DYNAMIC     Vx1        1       0:16:20 ago
 111    001c.736d.9c01    STATIC      Po7
 112    001c.7339.f7ae    DYNAMIC     Po5        1       0:05:57 ago
 112    001c.736d.9c01    STATIC      Po7
 132    001c.736d.9c01    STATIC      Po7
1198    001c.736d.9c01    STATIC      Po7
...
1199    001c.736d.9c01    STATIC      Po7
1199    001c.7370.81be    DYNAMIC     Vx1        1       3:27:54 ago
1199    021c.730e.779e    DYNAMIC     Vx1        1       3:27:54 ago
1199    021c.7317.766b    DYNAMIC     Vx1        1       3:27:54 ago
1199    021c.7375.ed7d    DYNAMIC     Vx1        1       3:27:54 ago
3010    001c.736d.9c01    STATIC      Po7
3012    001c.736d.9c01    STATIC      Po7
4093    001c.736d.9c01    STATIC      Po7
4094    001c.736d.9c01    STATIC      Po7
...
Peer State                      :             primary
State changes                   :                   2
Last state change time          :         3:28:05 ago
Hardware ready                  :                True
Failover                        :               False
Failover Cause(s)               :             Unknown
Last failover change time       :               never
Secondary from failover         :               False
Peer MAC address                :   00:1c:73:6d:9c:01
...
Heartbeats sent/received        :           3130/3123
Peer monotonic clock offset     :    0.000435 seconds
...
Arista cEOSLab
Hardware version: 
Serial number: 3B7A78BD8305E7556D8F79C792AF9DBC
Hardware MAC address: 001c.73c6.b4da
System MAC address: 001c.73c6.b4da
...
----  -----------     ----      ---  ----             -----   ---------
 110  001c.73a4.f92c  EVPN      Vx1  192.168.254.17   1       0:16:10 ago
                                     192.168.254.18 
...
1199  021c.730e.779e  EVPN      Vx1  192.168.254.13   1       3:27:44 ago
