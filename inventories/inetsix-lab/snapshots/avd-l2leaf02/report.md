...
------------ ---------- ---------- ------------------- -------- ---------------
192.168.0.26  484592191 2179187169                  NA multihop 06/21/22 12:33 
192.168.0.27 2041644925 1878893652                  NA multihop 06/21/22 12:33 
...
Router identifier 192.168.253.23, local AS number 65108
Neighbor Status Codes: m - Under maintenance
  Description              Neighbor     V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  avd-rs01                 192.168.0.26 4 65000            340       299    0    0 03:28:44 Estab   95     95
  avd-rs02                 192.168.0.27 4 65000            347       303    0    0 03:28:45 Estab   95     95
```
## show bgp evpn
...
Et1                            up             up                 P2P_LINK_TO_AVD-SPINE1_Ethernet12
Et2                            up             up                 P2P_LINK_TO_AVD-SPINE2_Ethernet12
Et7                            up             up                 
Et8                            up             up                 
...
Neighbor Status Codes: m - Under maintenance
  Description              Neighbor      V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  avd-spine1_Ethernet12    172.31.251.84 4 65001            263       256    0    0 03:28:45 Estab   20     20
  avd-spine2_Ethernet12    172.31.251.86 4 65001            262       262    0    0 03:28:45 Estab   20     20
```
...
--------------- --------------------- ---------- ------------ --------- -------
Ethernet1       172.31.251.85/31      up         up              1500          
Ethernet2       172.31.251.87/31      up         up              1500          
Loopback0       192.168.253.23/32     up         up             65535          
Loopback1       192.168.252.23/32     up         up             65535          
Management0     10.73.252.32/24       up         up              1500          
...
Gateway of last resort is not set
 ...
 C        172.31.251.84/31 is directly connected, Ethernet1
 C        172.31.251.86/31 is directly connected, Ethernet2
 B E      192.168.0.26/32 [20/0] via 172.31.251.84, Ethernet1
 B E      192.168.0.27/32 [20/0] via 172.31.251.86, Ethernet2
 B E      192.168.1.1/32 [20/0] via 172.31.251.84, Ethernet1
 B E      192.168.1.2/32 [20/0] via 172.31.251.86, Ethernet2
 B E      192.168.252.22/32 [20/0] via 172.31.251.84, Ethernet1
                                   via 172.31.251.86, Ethernet2
 C        192.168.252.23/32 is directly connected, Loopback1
 B E      192.168.253.22/32 [20/0] via 172.31.251.84, Ethernet1
                                   via 172.31.251.86, Ethernet2
 C        192.168.253.23/32 is directly connected, Loopback0
 B E      192.168.254.13/32 [20/0] via 172.31.251.84, Ethernet1
                                   via 172.31.251.86, Ethernet2
 B E      192.168.254.15/32 [20/0] via 172.31.251.84, Ethernet1
                                   via 172.31.251.86, Ethernet2
 B E      192.168.254.17/32 [20/0] via 172.31.251.84, Ethernet1
                                   via 172.31.251.86, Ethernet2
 B E      192.168.254.18/32 [20/0] via 172.31.251.84, Ethernet1
                                   via 172.31.251.86, Ethernet2
 B E      192.168.254.19/32 [20/0] via 172.31.251.84, Ethernet1
                                   via 172.31.251.86, Ethernet2
 B E      192.168.254.21/32 [20/0] via 172.31.251.84, Ethernet1
                                   via 172.31.251.86, Ethernet2
 B E      192.168.255.13/32 [20/0] via 172.31.251.84, Ethernet1
                                   via 172.31.251.86, Ethernet2
 B E      192.168.255.14/32 [20/0] via 172.31.251.84, Ethernet1
                                   via 172.31.251.86, Ethernet2
 B E      192.168.255.15/32 [20/0] via 172.31.251.84, Ethernet1
                                   via 172.31.251.86, Ethernet2
 B E      192.168.255.16/32 [20/0] via 172.31.251.84, Ethernet1
                                   via 172.31.251.86, Ethernet2
 B E      192.168.255.17/32 [20/0] via 172.31.251.84, Ethernet1
                                   via 172.31.251.86, Ethernet2
 B E      192.168.255.18/32 [20/0] via 172.31.251.84, Ethernet1
                                   via 172.31.251.86, Ethernet2
 B E      192.168.255.19/32 [20/0] via 172.31.251.84, Ethernet1
                                   via 172.31.251.86, Ethernet2
 B E      192.168.255.20/32 [20/0] via 172.31.251.84, Ethernet1
                                   via 172.31.251.86, Ethernet2
 B E      192.168.255.21/32 [20/0] via 172.31.251.84, Ethernet1
                                   via 172.31.251.86, Ethernet2
 B E      192.168.255.22/32 [20/0] via 172.31.251.84, Ethernet1
                                   via 172.31.251.86, Ethernet2
...
---------- ------------------------ ---------------------- ---
Et1           avd-spine1               Ethernet12          120
Et2           avd-spine2               Ethernet12          120
Et7           avd-l2leaf01             Ethernet7           120
Et8           avd-l2leaf01             Ethernet8           120
...
1199    001c.732a.2e9d    DYNAMIC     Vx1        1       3:28:50 ago
1199    001c.7370.81be    DYNAMIC     Vx1        1       3:28:37 ago
1199    021c.730e.779e    DYNAMIC     Vx1        1       3:28:32 ago
1199    021c.7317.766b    DYNAMIC     Vx1        1       3:28:25 ago
...
Arista cEOSLab
Hardware version: 
Serial number: EDFF752315582FEC772092DCB802DF07
Hardware MAC address: 001c.7381.6d18
System MAC address: 001c.7381.6d18
