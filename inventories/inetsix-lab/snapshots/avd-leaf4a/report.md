...
------------ ---------- ---------- ------------------- -------- ---------------
192.168.0.26 3628756170 2489187906                  NA multihop 06/21/22 12:33 
192.168.0.27 1698767426 4241723100                  NA multihop 06/21/22 12:33 
...
Router identifier 192.168.255.18, local AS number 65104
Neighbor Status Codes: m - Under maintenance
  Description              Neighbor     V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  avd-rs01                 192.168.0.26 4 65000            331       309    0    0 03:28:06 Estab   85     85
  avd-rs02                 192.168.0.27 4 65000            335       314    0    0 03:28:02 Estab   85     85
```
## show bgp evpn
...
Et1                            up             up                 P2P_LINK_TO_AVD-SPINE1_Ethernet8
Et2                            up             up                 P2P_LINK_TO_AVD-SPINE2_Ethernet8
Et5                            up             up                 srv-pod03_Ethernet2
Et7                            up             up                 
Et8                            up             up                 
...
Neighbor Status Codes: m - Under maintenance
  Description              Neighbor      V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  avd-spine1_Ethernet8     172.31.255.60 4 65001            266       255    0    0 03:28:04 Estab   20     20
  avd-spine2_Ethernet8     172.31.255.62 4 65001            262       263    0    0 03:28:03 Estab   20     20
...
--------------- --------------------- ---------- ------------ --------- -------
Ethernet1       172.31.255.61/31      up         up              1500          
Ethernet2       172.31.255.63/31      up         up              1500          
Loopback0       192.168.255.18/32     up         up             65535          
Loopback1       192.168.254.18/32     up         up             65535          
Management0     10.73.252.18/24       up         up              1500          
...
Gateway of last resort is not set
 ...
 C        172.31.255.60/31 is directly connected, Ethernet1
 C        172.31.255.62/31 is directly connected, Ethernet2
 B E      192.168.0.26/32 [20/0] via 172.31.255.60, Ethernet1
 B E      192.168.0.27/32 [20/0] via 172.31.255.62, Ethernet2
 B E      192.168.1.1/32 [20/0] via 172.31.255.60, Ethernet1
 B E      192.168.1.2/32 [20/0] via 172.31.255.62, Ethernet2
 B E      192.168.252.22/32 [20/0] via 172.31.255.60, Ethernet1
                                   via 172.31.255.62, Ethernet2
 B E      192.168.252.23/32 [20/0] via 172.31.255.60, Ethernet1
                                   via 172.31.255.62, Ethernet2
 B E      192.168.253.22/32 [20/0] via 172.31.255.60, Ethernet1
                                   via 172.31.255.62, Ethernet2
 B E      192.168.253.23/32 [20/0] via 172.31.255.60, Ethernet1
                                   via 172.31.255.62, Ethernet2
 B E      192.168.254.13/32 [20/0] via 172.31.255.60, Ethernet1
                                   via 172.31.255.62, Ethernet2
 B E      192.168.254.15/32 [20/0] via 172.31.255.60, Ethernet1
                                   via 172.31.255.62, Ethernet2
 B E      192.168.254.17/32 [20/0] via 172.31.255.60, Ethernet1
                                   via 172.31.255.62, Ethernet2
 C        192.168.254.18/32 is directly connected, Loopback1
 B E      192.168.254.19/32 [20/0] via 172.31.255.60, Ethernet1
                                   via 172.31.255.62, Ethernet2
 B E      192.168.254.21/32 [20/0] via 172.31.255.60, Ethernet1
                                   via 172.31.255.62, Ethernet2
 B E      192.168.255.13/32 [20/0] via 172.31.255.60, Ethernet1
                                   via 172.31.255.62, Ethernet2
 B E      192.168.255.14/32 [20/0] via 172.31.255.60, Ethernet1
                                   via 172.31.255.62, Ethernet2
 B E      192.168.255.15/32 [20/0] via 172.31.255.60, Ethernet1
                                   via 172.31.255.62, Ethernet2
 B E      192.168.255.16/32 [20/0] via 172.31.255.60, Ethernet1
                                   via 172.31.255.62, Ethernet2
 B E      192.168.255.17/32 [20/0] via 172.31.255.60, Ethernet1
                                   via 172.31.255.62, Ethernet2
 C        192.168.255.18/32 is directly connected, Loopback0
 B E      192.168.255.19/32 [20/0] via 172.31.255.60, Ethernet1
                                   via 172.31.255.62, Ethernet2
 B E      192.168.255.20/32 [20/0] via 172.31.255.60, Ethernet1
                                   via 172.31.255.62, Ethernet2
 B E      192.168.255.21/32 [20/0] via 172.31.255.60, Ethernet1
                                   via 172.31.255.62, Ethernet2
 B E      192.168.255.22/32 [20/0] via 172.31.255.60, Ethernet1
                                   via 172.31.255.62, Ethernet2
...
---------- ------------------------ ---------------------- ---
Et1           avd-spine1               Ethernet8           120
Et2           avd-spine2               Ethernet8           120
Et5           srv-pod03                Ethernet2           120
Et7           avd-leaf3a               Ethernet7           120
Et8           avd-leaf3a               Ethernet8           120
...
----    -----------       ----        -----      -----   ---------
 110    001c.73a4.f92c    DYNAMIC     Po5        1       0:16:25 ago
1198    021c.730e.779e    DYNAMIC     Vx1        1       3:28:09 ago
1198    021c.736d.9c01    DYNAMIC     Vx1        1       3:28:01 ago
1198    021c.7375.ed7d    DYNAMIC     Vx1        1       3:28:20 ago
1199    001c.7370.81be    DYNAMIC     Vx1        1       3:28:15 ago
1199    021c.730e.779e    DYNAMIC     Vx1        1       3:28:09 ago
1199    021c.7317.766b    DYNAMIC     Vx1        1       3:28:02 ago
1199    021c.736d.9c01    DYNAMIC     Vx1        1       3:28:01 ago
1199    021c.7375.ed7d    DYNAMIC     Vx1        1       3:28:20 ago
...
Arista cEOSLab
Hardware version: 
Serial number: 61FB27A75A66922606AE60E4393B4696
Hardware MAC address: 001c.732a.2e9d
System MAC address: 001c.732a.2e9d
...
----  -----------     ----      ---  ----             -----   ---------
 110  001c.73a4.f92c  EVPN      Vx1  0.0.0.0          1       0:16:15 ago
1198  021c.730e.779e  EVPN      Vx1  192.168.254.13   1       3:27:59 ago
1198  021c.736d.9c01  EVPN      Vx1  192.168.254.15   1       3:27:50 ago
1198  021c.7375.ed7d  EVPN      Vx1  192.168.254.21   1       3:28:10 ago
1199  001c.7370.81be  EVPN      Vx1  192.168.254.17   1       3:28:04 ago
1199  021c.730e.779e  EVPN      Vx1  192.168.254.13   1       3:27:59 ago
1199  021c.7317.766b  EVPN      Vx1  192.168.254.19   1       3:27:51 ago
1199  021c.736d.9c01  EVPN      Vx1  192.168.254.15   1       3:27:50 ago
1199  021c.7375.ed7d  EVPN      Vx1  192.168.254.21   1       3:28:10 ago
