...
------------ ---------- ---------- ------------------- -------- ---------------
192.168.0.26  803857261  348880801                  NA multihop 06/21/22 12:34 
192.168.0.27 2050304147 1468068016                  NA multihop 06/21/22 12:34 
...
Router identifier 192.168.255.13, local AS number 65101
Neighbor Status Codes: m - Under maintenance
  Description              Neighbor     V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  avd-rs01                 192.168.0.26 4 65000            318       304    0    0 03:27:44 Estab   76     76
  avd-rs02                 192.168.0.27 4 65000            326       312    0    0 03:27:43 Estab   76     76
```
## show bgp evpn
 ...
 *  ec   RD: 192.168.255.22:11 ip-prefix 10.1.10.0/24
                                 192.168.254.21        -       100     0       65000 65106 i
 * >     RD: 192.168.255.13:11 ip-prefix 10.1.10.3/32
                                 -                     -       100     0       65000 65104 ?
 ...
 *  ec   RD: 192.168.255.16:11 ip-prefix 10.1.12.0/24
                                 192.168.254.15        -       100     0       65000 65102 i
 * >     RD: 192.168.255.13:11 ip-prefix 10.1.12.2/32
                                 -                     -       100     0       65000 65102 ?
 * >     RD: 192.168.255.13:11 ip-prefix 10.1.13.0/24
                                 -                     -       100     0       65000 65104 ?
 ...
 *       RD: 192.168.255.13:13 ip-prefix 10.1.31.0/24
                                 -                     -       100     0       ?
 * >     RD: 192.168.255.13:13 ip-prefix 10.1.32.0/24
                                 -                     -       100     0       65000 65102 ?
 ...
 *  ec   RD: 192.168.255.16:13 ip-prefix 10.1.32.0/24
                                 192.168.254.15        -       100     0       65000 65102 i
 * >     RD: 192.168.255.13:13 ip-prefix 10.3.1.0/24
                                 -                     -       100     0       65000 65106 ?
 ...
 *  ec   RD: 192.168.255.22:13 ip-prefix 10.3.1.0/24
                                 192.168.254.21        -       100     0       65000 65106 i
 * >     RD: 192.168.255.13:13 ip-prefix 10.3.2.0/24
                                 -                     -       100     0       65000 65106 ?
 ...
 *       RD: 192.168.255.13:13 ip-prefix 172.31.253.22/31
                                 -                     -       100     0       ?
 * >     RD: 192.168.255.13:11 ip-prefix 172.31.253.26/31
                                 -                     -       100     0       65000 65102 ?
 * >     RD: 192.168.255.13:13 ip-prefix 172.31.253.26/31
                                 -                     -       100     0       65000 65102 ?
 ...
 *  ec   RD: 192.168.255.16:13 ip-prefix 172.31.253.26/31
                                 192.168.254.15        -       100     0       65000 65102 i
 * >     RD: 192.168.255.13:11 ip-prefix 172.31.253.34/31
                                 -                     -       100     0       65000 65105 ?
 ...
 *  ec   RD: 192.168.255.20:11 ip-prefix 172.31.253.34/31
                                 192.168.254.19        -       100     0       65000 65105 i
 * >     RD: 192.168.255.13:11 ip-prefix 172.31.253.38/31
                                 -                     -       100     0       65000 65106 ?
 * >     RD: 192.168.255.13:13 ip-prefix 172.31.253.38/31
                                 -                     -       100     0       65000 65106 ?
...
Et1                            up             up                 P2P_LINK_TO_AVD-SPINE1_Ethernet1
Et2                            up             up                 P2P_LINK_TO_AVD-SPINE2_Ethernet1
Et5                            up             up                 AVD-AGG01_Ethernet1
Et7                            up             up                 MLAG_PEER_avd-leaf1b_Ethernet7
Et8                            up             up                 MLAG_PEER_avd-leaf1b_Ethernet8
Lo0                            up             up                 EVPN_Overlay_Peering
Lo1                            up             up                 VTEP_VXLAN_Tunnel_Source
Ma0                            up             up                 oob_management
Po5                            up             up                 AVD-AGG01_Po1
Po7                            up             up                 MLAG_PEER_avd-leaf1b_Po7
...
Neighbor Status Codes: m - Under maintenance
  Description              Neighbor      V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  avd-leaf1b               172.31.253.23 4 65101            264       259    0    0 03:27:45 Estab   23     23
  avd-spine1_Ethernet1     172.31.255.40 4 65001            258       259    0    0 03:27:40 Estab   19     19
  avd-spine2_Ethernet1     172.31.255.42 4 65001            265       260    0    0 03:27:39 Estab   19     19

BGP summary information for VRF pure_type5
Router identifier 192.168.255.13, local AS number 65101
Neighbor Status Codes: m - Under maintenance
  Description              Neighbor      V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  avd-leaf1b               172.31.253.23 4 65101            252       257    0    0 03:27:37 Estab   7      7

BGP summary information for VRF tenant_a_project01
Router identifier 192.168.255.13, local AS number 65101
Neighbor Status Codes: m - Under maintenance
  Description              Neighbor      V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  avd-leaf1b               172.31.253.23 4 65101            262       268    0    0 03:27:37 Estab   10     10
```
...
--------------- --------------------- ---------- ------------ --------- -------
Ethernet1       172.31.255.41/31      up         up              1500          
Ethernet2       172.31.255.43/31      up         up              1500          
Loopback0       192.168.255.13/32     up         up             65535          
Loopback1       192.168.254.13/32     up         up             65535          
Management0     10.73.252.11/24       up         up              1500          
...
Vlan3010        172.31.253.22/31      up         up              1500          
Vlan3012        172.31.253.22/31      up         up              1500          
Vlan4093        172.31.253.22/31      up         up              1500          
Vlan4094        172.31.253.20/31      up         up              1500
```
...
Gateway of last resort is not set
 ...
 C        172.31.255.42/31 is directly connected, Ethernet2
 B E      192.168.0.26/32 [20/0] via 172.31.255.40, Ethernet1
 B E      192.168.0.27/32 [20/0] via 172.31.255.42, Ethernet2
 B E      192.168.1.1/32 [20/0] via 172.31.255.40, Ethernet1
 B E      192.168.1.2/32 [20/0] via 172.31.255.42, Ethernet2
 B E      192.168.252.22/32 [20/0] via 172.31.255.40, Ethernet1
                                   via 172.31.255.42, Ethernet2
 B E      192.168.252.23/32 [20/0] via 172.31.255.40, Ethernet1
                                   via 172.31.255.42, Ethernet2
 B E      192.168.253.22/32 [20/0] via 172.31.255.40, Ethernet1
                                   via 172.31.255.42, Ethernet2
 B E      192.168.253.23/32 [20/0] via 172.31.255.40, Ethernet1
                                   via 172.31.255.42, Ethernet2
 C        192.168.254.13/32 is directly connected, Loopback1
 B E      192.168.254.15/32 [20/0] via 172.31.255.40, Ethernet1
                                   via 172.31.255.42, Ethernet2
 B E      192.168.254.17/32 [20/0] via 172.31.255.40, Ethernet1
                                   via 172.31.255.42, Ethernet2
 B E      192.168.254.18/32 [20/0] via 172.31.255.40, Ethernet1
                                   via 172.31.255.42, Ethernet2
 B E      192.168.254.19/32 [20/0] via 172.31.255.40, Ethernet1
                                   via 172.31.255.42, Ethernet2
 B E      192.168.254.21/32 [20/0] via 172.31.255.40, Ethernet1
                                   via 172.31.255.42, Ethernet2
 C        192.168.255.13/32 is directly connected, Loopback0
 B I      192.168.255.14/32 [200/0] via 172.31.253.23, Vlan4093
 B E      192.168.255.15/32 [20/0] via 172.31.255.40, Ethernet1
                                   via 172.31.255.42, Ethernet2
 B E      192.168.255.16/32 [20/0] via 172.31.255.40, Ethernet1
                                   via 172.31.255.42, Ethernet2
 B E      192.168.255.17/32 [20/0] via 172.31.255.40, Ethernet1
                                   via 172.31.255.42, Ethernet2
 B E      192.168.255.18/32 [20/0] via 172.31.255.40, Ethernet1
                                   via 172.31.255.42, Ethernet2
 B E      192.168.255.19/32 [20/0] via 172.31.255.40, Ethernet1
                                   via 172.31.255.42, Ethernet2
 B E      192.168.255.20/32 [20/0] via 172.31.255.40, Ethernet1
                                   via 172.31.255.42, Ethernet2
 B E      192.168.255.21/32 [20/0] via 172.31.255.40, Ethernet1
                                   via 172.31.255.42, Ethernet2
 B E      192.168.255.22/32 [20/0] via 172.31.255.40, Ethernet1
                                   via 172.31.255.42, Ethernet2
...
---------- ------------------------ ---------------------- ---
Et1           avd-spine1               Ethernet1           120
Et2           avd-spine2               Ethernet1           120
Et5           avd-agg01                Ethernet1           120
Et7           avd-leaf1b               Ethernet7           120
Et8           avd-leaf1b               Ethernet8           120
...
----    -----------       ----        -----      -----   ---------
 110    001c.7399.7604    STATIC      Po7
 110    001c.73a4.f92c    DYNAMIC     Vx1        1       0:16:25 ago
 111    001c.7399.7604    STATIC      Po7
 112    001c.7339.f7ae    DYNAMIC     Vx1        1       0:06:01 ago
 112    001c.7399.7604    STATIC      Po7
 131    001c.7399.7604    STATIC      Po7
1198    001c.7399.7604    STATIC      Po7
1198    021c.736d.9c01    DYNAMIC     Vx1        1       3:28:00 ago
1198    021c.7375.ed7d    DYNAMIC     Vx1        1       3:28:08 ago
1199    001c.732a.2e9d    DYNAMIC     Vx1        1       3:28:08 ago
1199    001c.7370.81be    DYNAMIC     Vx1        1       3:28:08 ago
1199    001c.7399.7604    STATIC      Po7
1199    021c.7317.766b    DYNAMIC     Vx1        1       3:28:01 ago
1199    021c.736d.9c01    DYNAMIC     Vx1        1       3:28:00 ago
1199    021c.7375.ed7d    DYNAMIC     Vx1        1       3:28:08 ago
3010    001c.7399.7604    STATIC      Po7
3012    001c.7399.7604    STATIC      Po7
4093    001c.7399.7604    STATIC      Po7
4094    001c.7399.7604    STATIC      Po7
...
State changes                   :                   2
Last state change time          :         3:28:18 ago
Hardware ready                  :                True
Failover                        :               False
Failover Cause(s)               :             Unknown
Last failover change time       :               never
Secondary from failover         :               False
Peer MAC address                :   00:1c:73:99:76:04
...
Heartbeats sent/received        :           3135/3127
Peer monotonic clock offset     :   -0.000591 seconds
...
Arista cEOSLab
Hardware version: 
Serial number: ACF32CBEEE4AADCF1852276E4AEAF101
Hardware MAC address: 001c.730e.779e
System MAC address: 001c.730e.779e
...
Uptime: 3 hours and 26 minutes
Total memory: 41085292 kB
Free memory: 8205380 kB
```
## show vlan
...
----  -----------     ----      ---  ----             -----   ---------
 110  001c.73a4.f92c  EVPN      Vx1  192.168.254.17   1       0:16:13 ago
                                     192.168.254.18 
 112  001c.7339.f7ae  EVPN      Vx1  192.168.254.15   1       0:05:50 ago
1198  021c.736d.9c01  EVPN      Vx1  192.168.254.15   1       3:27:49 ago
1198  021c.7375.ed7d  EVPN      Vx1  192.168.254.21   1       3:27:56 ago
1199  001c.732a.2e9d  EVPN      Vx1  192.168.254.18   1       3:27:56 ago
1199  001c.7370.81be  EVPN      Vx1  192.168.254.17   1       3:27:57 ago
1199  021c.7317.766b  EVPN      Vx1  192.168.254.19   1       3:27:50 ago
1199  021c.736d.9c01  EVPN      Vx1  192.168.254.15   1       3:27:49 ago
1199  021c.7375.ed7d  EVPN      Vx1  192.168.254.21   1       3:27:57 ago
