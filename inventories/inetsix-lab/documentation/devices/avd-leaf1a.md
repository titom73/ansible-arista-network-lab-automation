...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 10.73.252.11/24 | 10.73.254.1 |
...
| --------- | --------------- | ------------ | --------- |
| avd_leaf1 | Vlan4094 | 172.31.253.21 | Port-Channel7 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | AVD-AGG01_Ethernet1 | *trunk | *110-112,131,201 | *- | *- | 5 |
| Ethernet7 | MLAG_PEER_avd-leaf1b_Ethernet7 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 7 |
| Ethernet8 | MLAG_PEER_avd-leaf1b_Ethernet8 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 7 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_AVD-SPINE1_Ethernet1 | routed | - | 172.31.255.41/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_AVD-SPINE2_Ethernet1 | routed | - | 172.31.255.43/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_AVD-SPINE1_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_AVD-SPINE2_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet5
   description AVD-AGG01_Ethernet1
   no shutdown
   channel-group 5 mode active
!
interface Ethernet7
   description MLAG_PEER_avd-leaf1b_Ethernet7
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description MLAG_PEER_avd-leaf1b_Ethernet8
   no shutdown
   channel-group 7 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel5 | AVD-AGG01_Po1 | switched | trunk | 110-112,131,201 | - | - | - | - | 5 | - |
| Port-Channel7 | MLAG_PEER_avd-leaf1b_Po7 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel7
   description MLAG_PEER_avd-leaf1b_Po7
   no shutdown
   switchport
