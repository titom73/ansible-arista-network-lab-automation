...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 10.73.252.16/24 | 10.73.254.1 |
...
| --------- | --------------- | ------------ | --------- |
| avd_bl01 | Vlan4094 | 172.31.253.32 | Port-Channel7 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet7 | MLAG_PEER_avd-bl01a_Ethernet7 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 7 |
| Ethernet8 | MLAG_PEER_avd-bl01a_Ethernet8 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 7 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_AVD-SPINE1_Ethernet6 | routed | - | 172.31.255.69/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_AVD-SPINE2_Ethernet6 | routed | - | 172.31.255.71/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_AVD-SPINE1_Ethernet6
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_AVD-SPINE2_Ethernet6
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet7
   description MLAG_PEER_avd-bl01a_Ethernet7
   no shutdown
   channel-group 7 mode active
!
interface Ethernet8
   description MLAG_PEER_avd-bl01a_Ethernet8
   no shutdown
   channel-group 7 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel7 | MLAG_PEER_avd-bl01a_Po7 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel7
   description MLAG_PEER_avd-bl01a_Po7
   no shutdown
   switchport
