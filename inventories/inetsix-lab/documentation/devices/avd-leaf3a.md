...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 10.73.252.17/24 | 10.73.254.1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet5 | srv-pod03_Ethernet1 | *trunk | *1-4000 | *- | *- | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_AVD-SPINE1_Ethernet7 | routed | - | 172.31.255.57/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_AVD-SPINE2_Ethernet7 | routed | - | 172.31.255.59/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_AVD-SPINE1_Ethernet7
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_AVD-SPINE2_Ethernet7
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet5
   description srv-pod03_Ethernet1
   no shutdown
...
router bgp 65103
   ...
   neighbor 172.31.255.56 description avd-spine1_Ethernet7
   neighbor 172.31.255.58 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.58 remote-as 65001
   neighbor 172.31.255.58 description avd-spine2_Ethernet7
