...
----------- ---------- ---------- ------------------- --------- ---------------
192.168.0.2 2623713091  608654585                  NA multihop  01/05/22 17:03 
192.168.0.3  885904536 3883562802                  NA multihop  01/05/22 17:03 
...
Neighbor Status Codes: m - Under maintenance
  ...
  EAPI-RS01                192.168.0.2      4 65000             64        43    0    0 00:13:43 Estab   59     59
  EAPI-RS02                192.168.0.3      4 65000             58        66    0    0 00:13:43 Estab   59     59
```
## show bgp evpn
 ...
 *  ec   RD: 192.168.255.6:11 ip-prefix 10.1.12.0/24
                                 192.168.254.5         -       100     0       65000 65102 i
 * >     RD: 192.168.255.3:11 ip-prefix 10.1.13.0/24
                                 -                     -       100     0       65000 65103 ?
 ...
 *       RD: 192.168.255.3:13 ip-prefix 10.1.31.0/24
                                 -                     -       100     0       ?
 * >     RD: 192.168.255.3:13 ip-prefix 10.1.32.0/24
                                 -                     -       100     0       65000 65102 ?
 ...
 *  ec   RD: 192.168.255.6:13 ip-prefix 10.1.32.0/24
                                 192.168.254.5         -       100     0       65000 65102 i
 * >     RD: 192.168.255.3:13 ip-prefix 10.3.1.0/24
                                 -                     -       100     0       65000 65106 ?
 ...
 *  ec   RD: 192.168.255.12:13 ip-prefix 10.3.1.0/24
                                 192.168.254.11        -       100     0       65000 65106 i
 * >     RD: 192.168.255.3:13 ip-prefix 10.3.2.0/24
                                 -                     -       100     0       65000 65106 ?
 ...
 *       RD: 192.168.255.3:13 ip-prefix 172.31.253.2/31
                                 -                     -       100     0       ?
 * >     RD: 192.168.255.3:11 ip-prefix 172.31.253.6/31
                                 -                     -       100     0       65000 65102 ?
 * >     RD: 192.168.255.3:13 ip-prefix 172.31.253.6/31
                                 -                     -       100     0       65000 65102 ?
 ...
 *  ec   RD: 192.168.255.6:13 ip-prefix 172.31.253.6/31
                                 192.168.254.5         -       100     0       65000 65102 i
 * >     RD: 192.168.255.3:11 ip-prefix 172.31.253.14/31
                                 -                     -       100     0       65000 65105 ?
 ...
 *  ec   RD: 192.168.255.10:11 ip-prefix 172.31.253.14/31
                                 192.168.254.9         -       100     0       65000 65105 i
 * >     RD: 192.168.255.3:11 ip-prefix 172.31.253.18/31
                                 -                     -       100     0       65000 65106 ?
 * >     RD: 192.168.255.3:13 ip-prefix 172.31.253.18/31
                                 -                     -       100     0       65000 65106 ?
...
Et1                            up             up                 P2P_LINK_TO_EAPI-SPINE1_Ethernet1
Et2                            up             up                 P2P_LINK_TO_EAPI-SPINE2_Ethernet1
Et3                            up             up                 MLAG_PEER_EAPI-LEAF1B_Ethernet3
Et4                            up             up                 MLAG_PEER_EAPI-LEAF1B_Ethernet4
Et5                            up             up                 EAPI-AGG01_Ethernet1
Et6                            up             up                 
Et7                            up             up                 
Et8                            up             up                 
...
Po3                            up             up                 MLAG_PEER_EAPI-LEAF1B_Po3
...
Neighbor Status Codes: m - Under maintenance
  Description              Neighbor         V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  EAPI-LEAF1B              172.31.253.3     4 65101             31        32    0    0 00:13:37 Estab   23     23
  EAPI-SPINE1_Ethernet1    172.31.255.0     4 65001             33        25    0    0 00:13:42 Estab   19     19
  EAPI-SPINE2_Ethernet1    172.31.255.2     4 65001             32        30    0    0 00:13:42 Estab   19     19

BGP summary information for VRF PURE_TYPE5
Router identifier 192.168.255.3, local AS number 65101
Neighbor Status Codes: m - Under maintenance
  Neighbor         V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  172.31.253.3     4 65101             23        26    0    0 00:13:38 Estab   7      7

BGP summary information for VRF TENANT_A_PROJECT01
Router identifier 192.168.255.3, local AS number 65101
Neighbor Status Codes: m - Under maintenance
  Neighbor         V AS           MsgRcvd   MsgSent  InQ OutQ  Up/Down State   PfxRcd PfxAcc
  172.31.253.3     4 65101             25        25    0    0 00:13:37 Estab   8      8
```
...
Management1     10.73.254.11/24      up         up              1500           
...
Vlan3010        172.31.253.2/31      up         up              1500           
Vlan3012        172.31.253.2/31      up         up              1500           
Vlan4093        172.31.253.2/31      up         up              1500           
Vlan4094        172.31.253.0/31      up         up              1500
```
...
Gateway of last resort is not set
 ...
 C        172.31.255.2/31 is directly connected, Ethernet2
 B E      192.168.0.2/32 [20/0] via 172.31.255.0, Ethernet1
 B E      192.168.0.3/32 [20/0] via 172.31.255.2, Ethernet2
 B E      192.168.1.1/32 [20/0] via 172.31.255.0, Ethernet1
 B E      192.168.1.2/32 [20/0] via 172.31.255.2, Ethernet2
 B E      192.168.252.2/32 [20/0] via 172.31.255.0, Ethernet1
                                  via 172.31.255.2, Ethernet2
 B E      192.168.252.3/32 [20/0] via 172.31.255.0, Ethernet1
                                  via 172.31.255.2, Ethernet2
 B E      192.168.253.2/32 [20/0] via 172.31.255.0, Ethernet1
                                  via 172.31.255.2, Ethernet2
 B E      192.168.253.3/32 [20/0] via 172.31.255.0, Ethernet1
                                  via 172.31.255.2, Ethernet2
 C        192.168.254.3/32 is directly connected, Loopback1
 B E      192.168.254.5/32 [20/0] via 172.31.255.0, Ethernet1
                                  via 172.31.255.2, Ethernet2
 B E      192.168.254.7/32 [20/0] via 172.31.255.0, Ethernet1
                                  via 172.31.255.2, Ethernet2
 B E      192.168.254.8/32 [20/0] via 172.31.255.0, Ethernet1
                                  via 172.31.255.2, Ethernet2
 B E      192.168.254.9/32 [20/0] via 172.31.255.0, Ethernet1
                                  via 172.31.255.2, Ethernet2
 B E      192.168.254.11/32 [20/0] via 172.31.255.0, Ethernet1
                                   via 172.31.255.2, Ethernet2
 C        192.168.255.3/32 is directly connected, Loopback0
 B I      192.168.255.4/32 [200/0] via 172.31.253.3, Vlan4093
 B E      192.168.255.5/32 [20/0] via 172.31.255.0, Ethernet1
                                  via 172.31.255.2, Ethernet2
 B E      192.168.255.6/32 [20/0] via 172.31.255.0, Ethernet1
                                  via 172.31.255.2, Ethernet2
 B E      192.168.255.7/32 [20/0] via 172.31.255.0, Ethernet1
                                  via 172.31.255.2, Ethernet2
 B E      192.168.255.8/32 [20/0] via 172.31.255.0, Ethernet1
                                  via 172.31.255.2, Ethernet2
 B E      192.168.255.9/32 [20/0] via 172.31.255.0, Ethernet1
                                  via 172.31.255.2, Ethernet2
 B E      192.168.255.10/32 [20/0] via 172.31.255.0, Ethernet1
                                   via 172.31.255.2, Ethernet2
 B E      192.168.255.11/32 [20/0] via 172.31.255.0, Ethernet1
                                   via 172.31.255.2, Ethernet2
 B E      192.168.255.12/32 [20/0] via 172.31.255.0, Ethernet1
                                   via 172.31.255.2, Ethernet2
...
```
Last table change time   : 0:13:19 ago
...
---------- ------------------------ ---------------------- ---
Et1           EAPI-SPINE1              Ethernet1           120
Et2           EAPI-SPINE2              Ethernet1           120
Et3           EAPI-LEAF1B              Ethernet3           120
Et4           EAPI-LEAF1B              Ethernet4           120
Et5           EAPI-AGG01               Ethernet1           120
```
...
----    -----------       ----        -----      -----   ---------
 110    0c1d.c0f4.7b39    STATIC      Po3
 111    0c1d.c0f4.7b39    STATIC      Po3
 112    0c1d.c0f4.7b39    STATIC      Po3
 131    0c1d.c0f4.7b39    STATIC      Po3
1197    0c1d.c0f4.7b39    STATIC      Po3
1197    0e1d.c0a3.43e0    DYNAMIC     Vx1        1       0:14:02 ago
1197    5201.0068.b446    DYNAMIC     Vx1        1       0:07:13 ago
1198    0c1d.c0d2.9e98    DYNAMIC     Vx1        1       0:14:02 ago
1198    0c1d.c0e4.777b    DYNAMIC     Vx1        1       0:14:02 ago
1198    0c1d.c0f4.7b39    STATIC      Po3
1198    0e1d.c025.6541    DYNAMIC     Vx1        1       0:14:02 ago
1198    0e1d.c0a3.43e0    DYNAMIC     Vx1        1       0:14:02 ago
1198    5201.0068.b446    DYNAMIC     Vx1        1       0:07:13 ago
3010    0c1d.c0f4.7b39    STATIC      Po3
3012    0c1d.c0f4.7b39    STATIC      Po3
4093    0c1d.c0f4.7b39    STATIC      Po3
4094    0c1d.c0f4.7b39    STATIC      Po3
...
Peer MAC address                :   0c:1d:c0:f4:7b:39
...
Heartbeats sent/received        :             230/219
Peer monotonic clock offset     :    1.672553 seconds
...
Arista vEOS-lab
Hardware version: 
Serial number: 260801F4060A0B76FB78DC93AD02E290
Hardware MAC address: 0c1d.c0f0.bdd1
System MAC address: 0c1d.c0f0.bdd1
...
1198  0c1d.c0d2.9e98  EVPN      Vx1  192.168.254.8    1       0:13:54 ago
1198  0c1d.c0e4.777b  EVPN      Vx1  192.168.254.7    1       0:13:54 ago
1198  0e1d.c025.6541  EVPN      Vx1  192.168.254.9    1       0:13:54 ago
1198  0e1d.c0a3.43e0  EVPN      Vx1  192.168.254.5    1       0:13:54 ago
