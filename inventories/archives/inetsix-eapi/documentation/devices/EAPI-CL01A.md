...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.73.254.19/24 | 10.73.254.253 |
...
| --------- | --------------- | ------------ | --------- |
| EAPI_CL01 | Vlan4094 | 172.31.253.37 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_EAPI-CL01B_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_EAPI-CL01B_Ethernet4 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_EAPI-SPINE1_Ethernet9 | routed | - | 172.31.255.73/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_EAPI-SPINE2_Ethernet9 | routed | - | 172.31.255.75/31 | default | 1500 | false | - | - |
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_EAPI-CL01B_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.168.255.21/32 |
...
| Vlan3010 |  TENANT_A_PROJECT01  |  172.31.253.38/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3012 |  CENTRAL_ROUTING  |  172.31.253.38/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  172.31.253.38/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.31.253.36/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------------- | -------------- | ---------- | --- |
| 172.31.253.39 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
| 172.31.255.72 | 65001 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
| 172.31.255.74 | 65001 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - |
...
| 172.31.253.39 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | CENTRAL_ROUTING | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
| 172.31.253.39 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | TENANT_A_PROJECT01 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| B-ELAN-201 | 192.168.255.21:20201 | 20201:20201 | - | - | learned | 201 |
| CENTRAL_ROUTING | 192.168.255.21:13 | 13:13 | - | - | learned | 301-302 |
| TENANT_A_PROJECT01 | 192.168.255.21:11 | 11:11 | - | - | learned | 110 |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| CENTRAL_ROUTING | 192.168.255.21:13 | connected |
| TENANT_A_PROJECT01 | 192.168.255.21:11 | connected<br>static |
...
router bgp 65106
   ...
   neighbor 172.31.253.39 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.31.253.39 description EAPI-CL01B
   neighbor 172.31.255.72 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.72 remote-as 65001
   neighbor 172.31.255.72 description EAPI-SPINE1_Ethernet9
   neighbor 172.31.255.74 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.74 remote-as 65001
   neighbor 172.31.255.74 description EAPI-SPINE2_Ethernet9
