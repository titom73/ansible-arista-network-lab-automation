...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.73.254.14/24 | 10.73.254.253 |
...
| --------- | --------------- | ------------ | --------- |
| EAPI_LEAF2 | Vlan4094 | 172.31.253.24 | Port-Channel3 |
...
| Ethernet5 | EAPI-AGG02_Ethernet2 | *trunk | *110-112,132,201 | *- | *- | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_EAPI-SPINE1_Ethernet4 | routed | - | 172.31.255.53/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_EAPI-SPINE2_Ethernet4 | routed | - | 172.31.255.55/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_EAPI-SPINE1_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_EAPI-SPINE2_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description MLAG_PEER_EAPI-LEAF2A_Ethernet3
   no shutdown
...
interface Port-Channel3
   description MLAG_PEER_EAPI-LEAF2A_Po3
   no shutdown
   switchport
