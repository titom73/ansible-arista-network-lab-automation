...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 10.73.254.51/24 | 10.73.254.253 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_EAPI-SPINE1_Ethernet13 | routed | - | 172.31.250.1/31 | default | 1500 | false | - | - |
...
| -------- | --------- | --- | -------------- | -------------- |
| 172.31.250.0 | 65001 | default | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS |
...
router bgp 65000
   ...
   neighbor 172.31.250.0 remote-as 65001
   neighbor 172.31.250.0 description EAPI-SPINE1_Ethernet13
