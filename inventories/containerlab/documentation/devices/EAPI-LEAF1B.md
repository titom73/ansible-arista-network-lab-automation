...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 10.73.254.12/24 | 10.73.254.253 |
...
| --------- | --------------- | ------------ | --------- |
| EAPI_LEAF1 | Vlan4094 | 172.31.253.0 | Port-Channel3 |
...
| Vlan3010 |  TENANT_A_PROJECT01  |  172.31.253.3/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3012 |  PURE_TYPE5  |  172.31.253.3/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  172.31.253.3/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.31.253.1/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------------- | -------------- |
| 172.31.253.2 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
...
| 172.31.253.2 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | PURE_TYPE5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.31.253.2 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | TENANT_A_PROJECT01 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
...
| --- | ------------------- | ------------ |
| PURE_TYPE5 | 192.168.255.4:13 | connected |
...
router bgp 65101
   ...
   neighbor 172.31.253.2 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.31.253.2 description EAPI-LEAF1A
