...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 10.73.255.114/24 | 10.73.255.1 |
...
| --------- | --------------- | ------------ | --------- |
| ceos_leaf2 | Vlan4094 | 172.31.253.24 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_ceos-leaf2a_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_ceos-leaf2a_Ethernet4 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet5 | CEOS-AGG02_Ethernet2 | *trunk | *110-112,132,201 | *- | *- | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_CEOS-SPINE1_Ethernet4 | routed | - | 172.31.255.53/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_CEOS-SPINE2_Ethernet4 | routed | - | 172.31.255.55/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_CEOS-SPINE1_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_CEOS-SPINE2_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description MLAG_PEER_ceos-leaf2a_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_ceos-leaf2a_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet5
   description CEOS-AGG02_Ethernet2
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_ceos-leaf2a_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
| Port-Channel5 | CEOS-AGG02_Po1 | switched | trunk | 110-112,132,201 | - | - | - | - | 5 | - |
...
interface Port-Channel3
   description MLAG_PEER_ceos-leaf2a_Po3
   no shutdown
   switchport
...
| Vlan3010 |  TENANT_A_PROJECT01  |  172.31.253.27/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3012 |  PURE_TYPE5  |  172.31.253.27/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  172.31.253.27/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.31.253.25/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------------- | -------------- |
| 172.31.253.26 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
...
| 192.168.1.1 | 65001 | default | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS |
| 192.168.1.2 | 65001 | default | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS |
| 172.31.253.26 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | PURE_TYPE5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.31.253.26 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | TENANT_A_PROJECT01 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| B-ELAN-201 | 192.168.255.16:20201 | 20201:20201 | - | - | learned | 201 |
| TENANT_A_PROJECT01 | 192.168.255.16:11 | 11:11 | - | - | learned | 110-112 |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| PURE_TYPE5 | 192.168.255.16:13 | connected |
| TENANT_A_PROJECT01 | 192.168.255.16:11 | connected<br>static |
...
router bgp 65102
   ...
   neighbor 172.31.253.26 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.31.253.26 description ceos-leaf2a
   neighbor 172.31.255.52 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.52 remote-as 65001
   neighbor 172.31.255.52 description ceos-spine1_Ethernet4
   neighbor 172.31.255.54 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.54 remote-as 65001
   neighbor 172.31.255.54 description ceos-spine2_Ethernet4
   neighbor 192.168.1.1 peer group EVPN-OVERLAY-PEERS
   neighbor 192.168.1.1 remote-as 65001
   neighbor 192.168.1.1 description ceos-spine1
   neighbor 192.168.1.2 peer group EVPN-OVERLAY-PEERS
   neighbor 192.168.1.2 remote-as 65001
   neighbor 192.168.1.2 description ceos-spine2
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan-aware-bundle B-ELAN-201
      rd 192.168.255.16:20201
      route-target both 20201:20201
      redistribute learned
      vlan 201
   !
   vlan-aware-bundle TENANT_A_PROJECT01
      rd 192.168.255.16:11
