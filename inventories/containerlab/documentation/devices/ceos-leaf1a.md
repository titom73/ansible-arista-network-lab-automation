...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 10.73.255.111/24 | 10.73.255.1 |
...
| --------- | --------------- | ------------ | --------- |
| ceos_leaf1 | Vlan4094 | 172.31.253.21 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_ceos-leaf1b_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet4 | MLAG_PEER_ceos-leaf1b_Ethernet4 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| Ethernet5 | CEOS-AGG01_Ethernet1 | *trunk | *110-112,131,201 | *- | *- | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_CEOS-SPINE1_Ethernet1 | routed | - | 172.31.255.41/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_CEOS-SPINE2_Ethernet1 | routed | - | 172.31.255.43/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_CEOS-SPINE1_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_CEOS-SPINE2_Ethernet1
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet3
   description MLAG_PEER_ceos-leaf1b_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_ceos-leaf1b_Ethernet4
   no shutdown
   channel-group 3 mode active
!
interface Ethernet5
   description CEOS-AGG01_Ethernet1
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_ceos-leaf1b_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
| Port-Channel5 | CEOS-AGG01_Po1 | switched | trunk | 110-112,131,201 | - | - | - | - | 5 | - |
...
interface Port-Channel3
   description MLAG_PEER_ceos-leaf1b_Po3
   no shutdown
   switchport
...
| Vlan3010 |  TENANT_A_PROJECT01  |  172.31.253.22/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan3012 |  PURE_TYPE5  |  172.31.253.22/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  172.31.253.22/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.31.253.20/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------------- | -------------- |
| 172.31.253.23 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
...
| 172.31.253.23 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | PURE_TYPE5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
| 172.31.253.23 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | TENANT_A_PROJECT01 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| B-ELAN-201 | 192.168.255.13:20201 | 20201:20201 | - | - | learned | 201 |
| TENANT_A_PROJECT01 | 192.168.255.13:11 | 11:11 | - | - | learned | 110-112 |

#### Router BGP EVPN VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| PURE_TYPE5 | 192.168.255.13:13 | connected |
| TENANT_A_PROJECT01 | 192.168.255.13:11 | connected<br>static |
...
router bgp 65101
   ...
   neighbor 172.31.253.23 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.31.253.23 description ceos-leaf1b
   neighbor 172.31.255.40 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.40 remote-as 65001
   neighbor 172.31.255.40 description ceos-spine1_Ethernet1
   neighbor 172.31.255.42 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.42 remote-as 65001
   neighbor 172.31.255.42 description ceos-spine2_Ethernet1
