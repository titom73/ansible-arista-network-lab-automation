...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 10.73.255.117/24 | 10.73.255.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_CEOS-SPINE1_Ethernet7 | routed | - | 172.31.255.57/31 | default | 1500 | false | - | - |
| Ethernet2 | P2P_LINK_TO_CEOS-SPINE2_Ethernet7 | routed | - | 172.31.255.59/31 | default | 1500 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_CEOS-SPINE1_Ethernet7
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_CEOS-SPINE2_Ethernet7
   no shutdown
   mtu 1500
   no switchport
...
router bgp 65103
   ...
   neighbor 172.31.255.56 description ceos-spine1_Ethernet7
   neighbor 172.31.255.58 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.58 remote-as 65001
   neighbor 172.31.255.58 description ceos-spine2_Ethernet7
