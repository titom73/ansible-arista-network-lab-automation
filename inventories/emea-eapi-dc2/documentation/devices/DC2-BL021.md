...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | ------- | --- | ---------- | ------------ |
| Port-Channel3 | MLAG_PEER_DC2-BL020_Po3 | 1500 | switched | trunk | 2-4094 | LEAF_PEER_L3<br> MLAG | - | - | - | - |

### Port-Channel Interfaces Device Configuration

```eos
interface Port-Channel3
   description MLAG_PEER_DC2-BL020_Po3
...
| Ethernet3 | MLAG_PEER_DC2-BL020_Ethernet3 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
| Ethernet4 | MLAG_PEER_DC2-BL020_Ethernet4 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
...
!
interface Ethernet3
   description MLAG_PEER_DC2-BL020_Ethernet3
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_DC2-BL020_Ethernet4
   channel-group 3 mode active
!
```
...
| --------- | --------------- | ------------ | --------- |
| DC2_BL | Vlan4094 | 10.255.249.8 | Port-Channel3 |
...
| Neighbor | Remote AS |
| -------- | ---------
| 10.255.250.8 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER |
