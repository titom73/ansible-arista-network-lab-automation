...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 10.73.2.14/16 | 10.73.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC2_BL01 | Vlan4094 | 10.255.249.9 | Port-Channel3 |
...
mlag configuration
   ...
   peer-address 10.255.249.9
   peer-address heartbeat 10.73.2.15 vrf MGMT
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | P2P_LINK_TO_DC2-SPINE1_Ethernet2 | 1500 | routed | access | - | - | - | 172.32.255.9/31 | - | - |
| Ethernet3 | MLAG_PEER_DC2-BL01B_Ethernet3 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
| Ethernet4 | MLAG_PEER_DC2-BL01B_Ethernet4 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
| Ethernet5 | P2P_LINK_TO_DDC1-BL01A_Ethernet5 | 1500 | routed | access | - | - | - | 172.255.0.2/31 | - | - |
...
!
interface Ethernet3
   description MLAG_PEER_DC2-BL01B_Ethernet3
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_DC2-BL01B_Ethernet4
   channel-group 3 mode active
!
interface Ethernet5
   description P2P_LINK_TO_DDC1-BL01A_Ethernet5
   no switchport
   ip address 172.255.0.2/31
```
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | ------- | -------- | --- | ---------- | ------------ |
| Port-Channel3 | MLAG_PEER_DC2-BL01B_Po3 | 1500 | switched | trunk | 2-4094 | LEAF_PEER_L3<br> MLAG | - | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_DC2-BL01B_Po3
...
| Vlan3009 | MLAG_PEER_L3_iBGP: vrf Tenant_A_OP_Zone | Tenant_A_OP_Zone | 10.255.250.8/31 | - | - |
| Vlan4093 | MLAG_PEER_L3_PEERING | Global Routing Table | 10.255.250.8/31 | - | - |
| Vlan4094 | MLAG_PEER | Global Routing Table | 10.255.249.8/31 | - | - |
...
| 192.168.255.12 | Inherited from peer group DCI-EVPN-OVERLAY-PEERS |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A_OP_Zone | 192.168.253.6:10 |  10:10  |  |  | learned | 110-111,114 |
| Tenant_D_OP_Zone_1 | 192.168.253.6:40411 |  40411:40411  |  |  | learned | 411 |
| Tenant_D_OP_Zone_2 | 192.168.253.6:40412 |  40412:40412  |  |  | learned | 412 |
...
| --- | ------------------- | ------------ |
| Tenant_A_OP_Zone | 192.168.253.6:10 | connected  |
...
router bgp 65201
   ...
   neighbor 192.168.255.12 peer group DCI-EVPN-OVERLAY-PEERS
   !
   ...
   vrf Tenant_A_OP_Zone
      ...
      router-id 192.168.253.6
      neighbor 10.255.250.9 peer group MLAG-IPv4-UNDERLAY-PEER
