...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 10.73.2.15/16 | 10.73.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC2_BL01 | Vlan4094 | 10.255.249.8 | Port-Channel3 |
...
mlag configuration
   ...
   peer-address heartbeat 10.73.2.14 vrf MGMT
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | P2P_LINK_TO_DC2-SPINE1_Ethernet3 | 1500 | routed | access | - | - | - | 172.32.255.11/31 | - | - |
| Ethernet3 | MLAG_PEER_DC2-BL01A_Ethernet3 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
| Ethernet4 | MLAG_PEER_DC2-BL01A_Ethernet4 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 3 | active |
| Ethernet5 | P2P_LINK_TO_DDC1-BL01A_Ethernet5 | 1500 | routed | access | - | - | - | 172.255.0.0/31 | - | - |
...
!
interface Ethernet3
   description MLAG_PEER_DC2-BL01A_Ethernet3
   channel-group 3 mode active
!
interface Ethernet4
   description MLAG_PEER_DC2-BL01A_Ethernet4
   channel-group 3 mode active
!
interface Ethernet5
   description P2P_LINK_TO_DDC1-BL01A_Ethernet5
   no switchport
   ip address 172.255.0.0/31
```
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | ------- | -------- | --- | ---------- | ------------ |
| Port-Channel3 | MLAG_PEER_DC2-BL01A_Po3 | 1500 | switched | trunk | 2-4094 | LEAF_PEER_L3<br> MLAG | - | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_DC2-BL01A_Po3
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | Global Routing Table | 192.168.253.7/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | Global Routing Table | 192.168.252.6/32 |
...
| Vlan3009 | MLAG_PEER_L3_iBGP: vrf Tenant_A_OP_Zone | Tenant_A_OP_Zone | 10.255.250.9/31 | - | - |
| Vlan4093 | MLAG_PEER_L3_PEERING | Global Routing Table | 10.255.250.9/31 | - | - |
| Vlan4094 | MLAG_PEER | Global Routing Table | 10.255.249.9/31 | - | - |
...
| Neighbor | Remote AS |
| -------- | ---------
| 172.255.0.1 | Inherited from peer group DCI-IPv4-UNDERLAY-PEERS |
| 192.168.253.1 | Inherited from peer group EVPN-OVERLAY-PEERS |
| 192.168.255.11 | Inherited from peer group DCI-EVPN-OVERLAY-PEERS |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| Tenant_A_OP_Zone | 192.168.253.7:10 |  10:10  |  |  | learned | 110-111,114 |
| Tenant_D_OP_Zone_1 | 192.168.253.7:40411 |  40411:40411  |  |  | learned | 411 |
| Tenant_D_OP_Zone_2 | 192.168.253.7:40412 |  40412:40412  |  |  | learned | 412 |
...
| --- | ------------------- | ------------ |
| Tenant_A_OP_Zone | 192.168.253.7:10 | connected  |
...
router bgp 65201
   ...
   neighbor DCI-EVPN-OVERLAY-PEERS remote-as 65110
   ...
   neighbor DCI-IPv4-UNDERLAY-PEERS remote-as 65110
   ...
   neighbor 172.255.0.1 peer group DCI-IPv4-UNDERLAY-PEERS
   neighbor 192.168.253.1 peer group EVPN-OVERLAY-PEERS
   neighbor 192.168.255.11 peer group DCI-EVPN-OVERLAY-PEERS
   !
...
| 20 | permit 10.255.250.0/24 le 31 |
...
ip prefix-list PL-P2P-UNDERLAY
   ...
   seq 20 permit 10.255.250.0/24 le 31
```
