...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | ------- | --- | ---------- | ------------ |
| Port-Channel1 | DC1-LEAF2A_Po5 | 1500 | switched | trunk |  | - | 1 | - | - | - |
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | DC1-LEAF2A_Ethernet5 | *1500 | *switched | *trunk | * | - | - | - | 1 | active |
| Ethernet2 | DC1-LEAF2B_Ethernet5 | *1500 | *switched | *trunk | * | - | - | - | 1 | active |
